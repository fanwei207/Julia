<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Test_exam_person.aspx.vb" Inherits="Test_Test_exam_person" %>
    ...
    <table id="table1" cellpadding="0" cellspacing="0" width="400" align="center">
        ...
        <tr>
            <td valign="top" align="left" width="450" colspan="2">
                ...
                <asp:CheckBox ID="ckball" runat="server" Text="全选" AutoPostBack="True" />
            </td>
        </tr>
        <tr>
            <td>
