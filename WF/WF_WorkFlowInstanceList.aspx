<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_WorkFlowInstanceList.aspx.cs"
    ...
    <div align="center">
        ...
        <table cellspacing="0" cellpadding="0" width="950px" class="main_top" border="0">
            <tr>
                ...
                <td>
                    <asp:Label ID="lblNbr" runat="server" Width="48px" CssClass="LabelRight" Text="申请号:"
                ...
                <td>
                    <asp:RadioButton ID="radProcess" runat="server" Text="进行中" GroupName="radGroup" Checked="true"
                        TabIndex="4" Width="60px" AutoPostBack="True" OnCheckedChanged="radProcess_CheckedChanged" />
                </td>
                <td>
                    <asp:RadioButton ID="radFinish" runat="server" Text="已完成" GroupName="radGroup" TabIndex="5"
                        Width="60px" AutoPostBack="True" OnCheckedChanged="radFinish_CheckedChanged" />
                </td>
                <td>
                    <asp:RadioButton ID="radCancel" runat="server" Text="被拒绝" GroupName="radGroup" TabIndex="6"
                ...
                <td>
                    <asp:Button ID="btnAdd" runat="server" CssClass="SmallButton3" TabIndex="8" Text="新增"
        ...
        <asp:GridView ID="gvWFI" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            CssClass="GridViewStyle AutoPageSize" PageSize="23" OnPreRender="gvWFI_PreRender" DataKeyNames="WFN_Nbr"
            OnRowDataBound="gvWFI_RowDataBound" OnPageIndexChanging="gvWFI_PageIndexChanging"
            Width="1140px" OnRowCommand="gvWFI_RowCommand">
            ...
            <EmptyDataTemplate>
                <asp:Table ID="Table1" Width="1140px" CellPadding="-1" CellSpacing="0" runat="server"
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Text="备注" Width="" HorizontalAlign="center"></asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </EmptyDataTemplate>
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="linkdetail" Text="<u>明细</u>" ForeColor="Blue" Font-Underline="true"
