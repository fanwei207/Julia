<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_ExcelEdit.aspx.cs" Inherits="WF_ExcelEdit"
                ...
                <table border="0" cellpadding="2" cellspacing="2" style="width: 900px">
                    <tr>
                        <td align="left" style="width: 550px">
                            <span style="color: black">如果页面无法显示，请安装</span><asp:HyperLink ID="hlOWC11" runat="server" NavigateUrl="~/docs/owc11.rar" Font-Underline="True" ForeColor="#0000C0">OWC11</asp:HyperLink>，安装后如果还显示不了，请联系管理员!</td>
                        <td align="right">
                            ...
                            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<asp:Button ID="BtnClose" runat="server" CausesValidation="true"
                                CssClass="SmallButton3" OnClick="BtnClose_Click" Text="关闭" Width="50px" />&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</td>
                    </tr>
                </table>
