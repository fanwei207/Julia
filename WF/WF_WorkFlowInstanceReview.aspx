<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_WorkFlowInstanceReview.aspx.cs"
    ...
    <div align="center">
        ...
        <iewc:MultiPage ID="TeamMultiTab" runat="server" Style="border-right: #0c65dd 2px solid;
            ...
            <iewc:PageView runat="server">
                <asp:Table ID="Table1" runat="server" BorderWidth="0px" Width="800px" GridLines="Both"
                    Height="410px">
                    <asp:TableRow runat="server">
                        <asp:TableCell ColumnSpan="3" VerticalAlign="Top" HorizontalAlign="Center" runat="server">
                            <table border="0" cellpadding="1" cellspacing="1" width="780">
                                <tr>
                                    <td align="right" style="width: 120px; height: 20px" valign="middle">
                                        申请号:
                                    </td>
                                    ...
                                    <td style="width: 200px; height: 20px" valign="middle">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" style="height: 22px" valign="middle">
                                        <input id="fileAttach" runat="server" cssclass="" style="width: 549px; height: 22px;
                                        ...
                                        &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        <asp:Button ID="btn_upload" runat="server" CssClass="SmallButton3" OnClick="btn_upload_Click"
                                            Text="上传" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 213px; height: 20px" valign="middle">
                                        <asp:TextBox ID="txtCreatedDate" runat="server" CssClass="SmallTextBox Date" Enabled="False"
                                            Height="20px" Width="130px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table id="tblReview" runat="server" border="0" cellpadding="1" cellspacing="1" style="width: 780px;
                                margin-top: 5px;">
                                <tr runat="server">
                                    <td align="right" style="width: 67px; height: 20px" valign="middle" runat="server">
                                        审批:
                                    </td>
                                    <td style="height: 20px;" valign="middle" runat="server">
                            ...
                            <table id="tblButton" runat="server" border="0" cellpadding="2" cellspacing="2" style="width: 300px">
                                <tr runat="server">
                                    <td align="left" colspan="2" runat="server">
                                        <asp:Button ID="btn_save" runat="server" CssClass="SmallButton3" OnClick="btn_save_Click"
                                        OnClientClick="getSaveFormDataSqlStr()"    Width="53px" Text="签署" />
                                        <asp:CheckBox ID="chkEmail" runat="server" Text="Email" Checked="True" />
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                                        <asp:Button ID="btn_return" runat="server" CssClass="SmallButton3" OnClick="btn_return_Click"
                                            Width="53px" Text="返回" />
                                  ...
                                  <tr>
                                    <td  id ="tdReject" runat ="server">
                                        <asp:Label ID ="lbReject" runat="server" Text ="驳回到："></asp:Label>
                                        
                                             
                                        <asp:DropDownList ID="ddlReject" runat="server"  DataTextField ="Node_Description"  DataValueField="Sort_Order" Width="150px"></asp:DropDownList>
                                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           <asp:Button ID="btn_reject" runat="server"  CssClass="SmallButton3"
                                             Width="53px" Text="驳回" OnClick="btn_reject_Click" />
                                    </td>
                                </tr>
                            </table>
                            <br />
