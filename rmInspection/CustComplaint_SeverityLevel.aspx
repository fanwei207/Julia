<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustComplaint_SeverityLevel.aspx.cs" Inherits="rmInspection_CustComplain_SeverityLevel" %>
...
<div align="center">
        <table cellspacing="2" cellpadding="2" width="600px" bgcolor="white" border="0">
            <tr> 
                <td>
                    <asp:Label ID="lblSeverity" runat="server" Width="55px" CssClass="LabelRight" Text="严重等级:"
                        Font-Bold="False"></asp:Label>
                    <asp:TextBox ID="txtSeverity" runat="server" Width="257px" TabIndex="1" MaxLength="30"
        ...
        <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
            ...
            Width="620px" DataKeyNames="SeverityID,CreatedBy" OnRowUpdating="gv_RowUpdating">
            ...
            <EmptyDataTemplate>
                <asp:Table ID="Table1" Width="620px" CellPadding="-1" CellSpacing="0" runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell Text="严重等级" Width="30px" HorizontalAlign="center" Font-Bold="false"></asp:TableCell>
