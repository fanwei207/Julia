<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.rm_detail_list" CodeFile="rm_detail_list.aspx.vb" %>
    ...
    <div align="center">
        ...
        <asp:DataGrid ID="Datagrid1" runat="server" Width="780px" CssClass="GridViewStyle"
            ...
            <Columns>
                ...
                <asp:ButtonColumn DataTextField="view" Text="附件" ItemStyle-Font-Underline="true" CommandName="docattach">
