...
public partial class wsline_wl_calendarModi : BasePage
{
    ...
    protected void BindData()
    {
        ...
        GridView1.DataSource = AttenInfo.SelectAttenInfo(year,month,/*day,*/userCenter,userType,plantID,userCode,checkType,isManual,isCompany);
        GridView1.DataBind();
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string StrSql = "sp_hr_disableAttendanceInfo";
        ...
        SqlHelper.ExecuteNonQuery(chk.dsn0(), CommandType.StoredProcedure, StrSql, parmArray);
    ...
    protected void btn_add_Click(object sender, EventArgs e)
    {
        ...
        else if ( !string.IsNullOrEmpty(septime.Text.Trim()))
        {
            if (!IsNumber(septime.Text.Trim()))
            {
                ltlAlert.Text = "请假时长(小时)必须是数字')";
                return;
            }
        }
        ...
        if (!Convert.ToBoolean(parmArray[14].Value))
        {
            this.Alert("更新失败！请联系管理员！");
        }
