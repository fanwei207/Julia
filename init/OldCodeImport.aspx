<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.OldCodeImport" CodeFile="OldCodeImport.aspx.vb" %>
    ...
    <div align="center">
                            ...
                            <td colspan="2">
                                <font face="Verdana, Arial, Helvetica, sans-serif" color="#cc0000">导入文件的格式如下：<br>
                                    ...
                                    <table cellspacing="0" cellpadding="2" width="100%" border="0">
                                        <tr>
                                            <td width="50%">
                                                <font face="Verdana, Arial, Helvetica, sans-serif">旧产品型号</font>
                                            </td>
                                            <td width="50%">
                                                <font face="Verdana, Arial, Helvetica, sans-serif">新产品型号</font>
                                            </td>
                                        </tr>
                                        <tr bgcolor="#eceef7">
                                            <td width="50%">
        ...
        <table cellspacing="2" cellpadding="2" width="600" bgcolor="white" border="0">
            ...
            <tr>
                ...
                <td align="center">
                    <input class="SmallButton2" id="uploadBtn" style="width: 120px" type="button" value="代码转换"
                        runat="server" />
                </td>
            </tr>
        </table>
