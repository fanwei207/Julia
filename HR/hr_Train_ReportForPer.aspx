<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hr_Train_ReportForPer.aspx.cs" Inherits="hr_Train_ReportForPer" %>
       ...
       <div align="center">
        ...
        <asp:GridView ID="gv_TrainReport" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="参训人员" DataField="train_EmpName" ReadOnly="True">
                    <HeaderStyle HorizontalAlign="Center" Width="50px" />
                    <ItemStyle HorizontalAlign="Center" Width="50px" />
                </asp:BoundField>
                <asp:BoundField HeaderText="参训部门" DataField="train_DeptMentName" ReadOnly="True">
                    <HeaderStyle HorizontalAlign="Center" Width="50px" />
                    <ItemStyle HorizontalAlign="Center" Width="50px" />
                </asp:BoundField>
                <asp:TemplateField>
