<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hr_leave.aspx.cs" Inherits="HR_hr_leave" %>
    ...
    <div align="center">
            ...
            <tr>
                ...
                <td align="center" style="width: 120px">
                    ...
                    <asp:DropDownList ID="ddlType" runat="server" Width="60px" Font-Size="10pt" AutoPostBack="True"
                        ...
                        <asp:ListItem Text="旷工" Value="5"></asp:ListItem>
        ...
        <asp:GridView ID="gvLeave" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <EmptyDataTemplate>
                <asp:Table ID="Table1" Width="780px" CellPadding="-1" CellSpacing="0" runat="server"
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Text="创建日期" Width="80px" HorizontalAlign="center"></asp:TableCell>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CreatedDate" HeaderText="创建日期" DataFormatString="{0:yyyy-MM-dd}"
                    HtmlEncode="false">
                    <HeaderStyle Width="80px" HorizontalAlign="Center" />
                    <ItemStyle Width="80px" HorizontalAlign="Center" />
                </asp:BoundField>
