<%@ Page Language="C#" AutoEventWireup="true" CodeFile="app_accessChooseApprove.aspx.cs"
 	...
 	function post()
		{
		    ...
		    window.opener.document.getElementById("txtChooseName").value = document.getElementById("txtApproveName").value;
		    window.opener.document.getElementById("txtChooseEmail").value = document.getElementById("txtApproveEmail").value;
		    window.opener.document.getElementById("txtChooseid").value = document.getElementById("txtApproveID").value;
	      window.close();
       	}		
	</script>
