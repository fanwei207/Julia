<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hr_DinnerImport.aspx.cs"
    Inherits="hr_DinnerImport" %>
    ...
    <div style="text-align: center">
        ...
        <table cellpadding="0" cellspacing="0" width="780" style="background-color: White"
            ...
            <tr>
                ...
                <td align="center">
                    <input class="SmallButton2" id="BtnDinnerImport" style="width: 120px" type="button"
                        value="导入就餐信息" name="BtnDinnerImport" runat="server" onserverclick="BtnDinnerImport_ServerClick" />
                </td>
            </tr>
