<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hr_holiday_notfee.aspx.cs" Inherits="HR_hr_holiday_notfee" %>
        ...
        <table cellspacing="0" cellpadding="0" width="250px">
            ...
            <tr>
                <td style="width: 100px" align="right">
                    <asp:Label ID="lbl_Holiday" runat="server" Text="节假日期:"></asp:Label>
                </td>
                <td>
        ...
        <asp:GridView ID="gvHoliday" runat="server" AllowPaging="False" CssClass="GridViewStyle"
            ...
            <EmptyDataTemplate>
                <asp:Table ID="Table1" Width="250px" CellPadding="-1" CellSpacing="0" runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell Text="节假日期" Width="200px" HorizontalAlign="center"></asp:TableCell>
                        <asp:TableCell Text="删除" Width="50px" HorizontalAlign="center"></asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </EmptyDataTemplate>
            <Columns>
                <asp:BoundField DataField="HolidayDate" HeaderText="节假日期" DataFormatString="{0:yyyy-MM-dd}"
                    HtmlEncode="false">
