<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hr_att_holidayImport.aspx.cs"
    Inherits="HR_hr_att_holidayImport" %>
    ...
    <div align="center">
        ...
        <table cellspacing="2" cellpadding="2" width="700" bgcolor="white" border="0">
            ...
            <tr>
                ...
                <td align="left" style="height: 18px; width: 500px" colspan="2">
                    <a href="/docs/TheNationalHolidayTemplates.xls" target="_blank"><font color="blue">导入模板</font></a>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <div align="center">
                        <asp:Button ID="btnBack" runat="server" CausesValidation="False" CssClass="SmallButton2"
                            Text="返回" Width="80px" OnClick="btnBack_Click" />
                    </div>
                </td>
            </tr>
        </table>
