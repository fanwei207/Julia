<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hr_salary_AdjustM.aspx.cs"
    Inherits="hr_salary_AdjustM" %>
    ...
    <div align="center">
        ...
        <table width="860px" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPercent" runat="server" Width="28px" TabIndex="10" 
            ...
            <tr>
                ...
                <td>
                    调整金额&nbsp;<asp:TextBox ID="txtMoney" runat="server" Width="80px" TabIndex="11"></asp:TextBox>
                </td>
        ...
        <asp:Button ID="btnFin" runat="server" Text="财务" CssClass="SmallButton2" 
            OnClick="btnFin_Click" Visible="False" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
