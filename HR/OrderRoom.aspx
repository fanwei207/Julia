            ...
            <tr>
                <td colspan="3">
                    ...
                    <asp:DropDownList ID="ddl_BeginMin" runat="server" 
                        ...
                        <asp:ListItem Text="00" Value="00" meta:resourcekey="ListItemResource8"></asp:ListItem>
                        <asp:ListItem Text="30" Value="30" meta:resourcekey="ListItemResource9"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td colspan="4">
                ...
                <td colspan="8">
                    ...
                    <asp:Panel ID="pn_ShowOders" runat="server" Width="100%"  
                        ...
                        <asp:GridView ID="gdv_MroomOrderList" runat="server" Width="99%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="MR_FormId" HeaderText="订单号" >
                                <HeaderStyle Width="120px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Mr_Deptname" HeaderText="部门" />
                                <asp:BoundField DataField="Mr_APPNAME" HeaderText="申请人" />
                                <asp:BoundField DataField="Mr_APPExtNo" HeaderText="联系方式" />
                                <asp:BoundField DataField="MR_begintime" 
                                    DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" HeaderText="开始时间" >
                                <HeaderStyle Width="160px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="MR_endtime" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" 
                                    HeaderText="结束时间">
                                <HeaderStyle Width="160px" />
                                </asp:BoundField>
                            </Columns>
