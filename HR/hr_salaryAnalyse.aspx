<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hr_salaryAnalyse.aspx.cs"
    Inherits="HR_hr_salaryAnalyse" %>
    ...
    <div align="center">
        ...
        <table width="780px" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="center">
                    <asp:Button ID="btnPieceSalary" runat="server" Text="计件工资分析表" OnClick="btnPieceSalary_Click"
            ...
            <tr>
                ...
                <td align="center">
                    <asp:Button ID="btnDecompose" runat="server" Text="计件工资分解表" CssClass="SmallButton2"
