<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hr_ChAttendance1.aspx.cs"
    Inherits="HR_hr_ChAttendance1" %>
...
<body>
    <div align="center">
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;<asp:Button ID="btnUpdate" runat="server" Text="更新" CssClass="SmallButton3"
                        OnClick="btnUpdate_Click" Width="60px" />
        ...
        <asp:ObjectDataSource ID="obdsAtt" runat="server" SelectMethod="CheckAttendance1"
