...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td style="height: 22px; text-align:center;">
                    &nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="btn_exportExcel" runat="server" Width="40"
                        ...
                        onclick="btn_exportExcel_Click" Visible="false" />&nbsp; &nbsp;
                    <asp:Button ID="btn_exportExcel2" runat="server" Width="94px" CssClass="SmallButton2"
                        ...
                        onclick="btn_exportExcel2_Click" Visible="false" />
                &nbsp;<asp:Button ID="btn_updateCC" runat="server" Width="94px" CssClass="SmallButton2"
                        ...
                        onclick="btn_updateCC_Click" Visible="false" />
        ...
        CssClass="GridViewStyle GridViewRebuild"    PageSize="20" AllowPaging="True" 
            ...
            onrowupdating="GridView1_RowUpdating"   DataKeyNames="AttendanceID,C_ID,AttendanceTime,HrType"
           ...
           <asp:TemplateField HeaderText="修改者" > 
            ...
            <asp:TemplateField HeaderText="打卡机号" Visible="false" > 
                <ItemTemplate> 
