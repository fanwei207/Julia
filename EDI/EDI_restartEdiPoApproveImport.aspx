<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDI_restartEdiPoApproveImport.aspx.cs" Inherits="EDI_EDI_restartEdiPoApproveImport" %>
                    ...
                    <tr>
                        ...
                        <td style="height: 20px; text-align: left;">
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Size="11px"
                                Font-Underline="True" NavigateUrl="~/docs/edirestart.xlsx">模板</asp:HyperLink>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 5; width: 398px;">
