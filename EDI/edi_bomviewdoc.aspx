<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.edi_bomviewdoc" CodeFile="edi_bomviewdoc.aspx.vb" %>
    ...
    <div align="left">
        ...
        <table cellspacing="0" cellpadding="0">
            <tr>
                ...
                <tr>
                <td align="right">
                    <asp:Button ID="btn_search" runat="server" CssClass="SmallButton3" Width="60" Text="Search">
                    </asp:Button>
                    &nbsp;
                    <asp:Button ID="Button1" runat="server" CssClass="SmallButton3" Text="Back" 
...
<%--                <asp:ButtonColumn Text="" HeaderText="Open" CommandName="docview" DataTextField="open">
                ...
                <asp:BoundColumn DataField="isDoc" ReadOnly="True" HeaderText="文档必须">
