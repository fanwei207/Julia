<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EDI_pocEffectDet.aspx.cs" Inherits="EDI_EDI_pocEffectDet" %>
        ...
        <div align="center">
            <table>
                ...
                <tr>
                   ...
                   <%-- DescEn:<asp:Label ID="lbDescEn" runat="server"></asp:Label>--%>
                        <asp:DropDownList ID="dropEffect" runat="server" Width="500px" DataTextField="poce_enDesc" DataValueField="poce_effectID"></asp:DropDownList></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle; text-align: left;">
                        <asp:RadioButton ID="radYes" runat="server" GroupName="valid" Text="Agree" Checked="true" />
                        &nbsp;
