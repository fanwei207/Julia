<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mail_checkWo.aspx.cs" Inherits="Mail_Check_mail_checkWo" validateRequest="false" %>
...
<body>
    ...
    <tr>
    <td>
    加工单:<asp:TextBox ID="txtOrder" runat="server" Width="120px"></asp:TextBox>
    </td>
    <td>
