<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mail_checkSo.aspx.cs" Inherits="Mail_Check_mail_checkSo" %>
...
<body>
    ...
    <tr>
    <td>
    销售单:<asp:TextBox ID="txtOrder" runat="server" Width="120px"></asp:TextBox>
    </td>
    <td>
