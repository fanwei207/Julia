<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.access" CodeFile="access.aspx.vb" %>
        ...
        <table cellspacing="1" cellpadding="1" width="600">
            <tr>
                <td valign="top" align="left" width="450" colspan="2" style="height: 28px">
                    ...
                    &nbsp;&nbsp; &nbsp; &nbsp;用户名<asp:DropDownList ID="DropDownList1" AutoPostBack="True"
            ...
            <tr>
                <td align="left" colspan="2" style="height: 28px" valign="top" width="450">
                    菜单<asp:DropDownList ID="dropMenuRoot" runat="server" Width="180px" AutoPostBack="True">
                    </asp:DropDownList>
