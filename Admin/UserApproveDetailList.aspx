<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserApproveDetailList.aspx.vb" Inherits="Admin_UserApproveDetailList" %>
    ...
    <div align="center">
        ...
        <asp:DataGrid ID="Datagrid1" runat="server" Width="780px" AutoGenerateColumns="False" CssClass="GridViewStyle">
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="docitem" HeaderText="项目">
                    <HeaderStyle Width="60px"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" Width="60px"></ItemStyle>
                </asp:BoundColumn>
                <asp:BoundColumn DataField="docs" HeaderText="内容">
