<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateFormNum.aspx.cs" Inherits="CreateFormNum" %>
            ...
            <%--            <asp:ListItem Value = "0" Selected = "True">--请选择--</asp:ListItem>
                ...
                <td width="250px">
                    <asp:Button ID="btnQuery" runat="server" CssClass="SmallButton3" OnClick="btnQuery_Click"
                        TabIndex="0" Text="查询" />
                    &nbsp;&nbsp;
                    <asp:DropDownList ID="ddl_year" runat="server" Width="60px" AutoPostBack="true"
