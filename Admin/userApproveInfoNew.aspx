<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.userApproveNew" CodeFile="userApproveInfoNew.aspx.vb" %>
...
<body>
    <div align="center">
        ...
        <table cellspacing="4" cellpadding="0" style="border:1px solid #d7d7d7; margin-top:2px;">
            ...
            <tr>
                <td style="height: 10px; width: 55px;" align="right">
                    &nbsp;用&nbsp; 户&nbsp; 名
                </td>
            ...
            <tr>
                ...
                <td valign="middle" align="center" colspan="2" rowspan="2">
                    <asp:Button ID="btnUpload" runat="server" Text="照片上传" Visible="false" />
                </td>
            </tr>
            <tr>
                ...
                <td style="height: 11px; width: 232px;">
                    <asp:TextBox ID="contractdate" TabIndex="16" runat="server" Width="183px" CssClass="SmallTextBox Date"
                        MaxLength="10"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="height: 11px">
                    <asp:TextBox ID="txtCoef" runat="server" CssClass="SmallTextBox" MaxLength="10" Width="160px"
            ...
            <tr>
                ...
                <td class="style2">
                    </td><td valign="middle" align="right" class="style3">
                        </td>
                <td class="style4">
                    </td>
                    <td class="style4"></td><td class="style4"></td>
            </tr>
            <tr>
                <td style="height: 16px; " align="center" colspan="6">
