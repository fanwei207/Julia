<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m5_new_Edit.aspx.cs" Inherits="m5_new_Edit" %>
    ...
    <form id="form1" runat="server">
        <div align="center">
            <table style="width: 600px">
                ...
                <tr>    <td style="text-align: left; height: 15px;"> 
                    Level:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:DropDownList ID ="ddlLevel" DataTextField ="soque_degreeName" DataValueField="soque_did" runat="server" Width="200px" >
                ...
                <tr>
                    <td style="text-align: left; height: 15px;">
                        ModelNo.: &nbsp;&nbsp;
                     <asp:TextBox ID="txtModelNo" runat="server" CssClass="SmallTextBox5" Width="200px" ></asp:TextBox>
                        </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: left;">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:CheckBox ID="cb_decsfile" Text="delete" runat="server" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: left; height: 15px;">Content：</td>
                </tr>
                <tr>
                    <td style="text-align: left; height: 15px;">
                ...
                <tr>
                    <td style="text-align: left; height: 15px;">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:CheckBox ID="cb_reasonfile" Text="delete" runat="server" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: center;">
                        <asp:Button ID="btnDone" runat="server" Text="save" CssClass="SmallButton3" OnClick="btnDone_Click" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btn_Back" runat="server" Text="return" CssClass="SmallButton3" OnClick="btn_Back_Click" />
                    </td>
                </tr>
            </table>
        </div>
