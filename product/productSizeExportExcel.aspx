<%@ Page Language="C#" AutoEventWireup="true" CodeFile="productSizeExportExcel.aspx.cs"
    Inherits="productSizeExportExcel" %>
            ...
            <tr>
                ...
                <td align="left" style="width: 135; height: 21px;">
                    <label id="here" onclick="submit();">
                        <a href="/docs/prodcutSize_ExportExcel.xlsx" target="blank"><font color="blue">导入模版</font></a></label>
                </td>
                <td align="center">
                    <asp:Button ID="btnShip" runat="server" CssClass="SmallButton2" OnClick="BtnShip_ServerClick"
                        Text="导入出运单" Width="68px" />
                </td>
            </tr>
        </table>
        </form>
