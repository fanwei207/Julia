<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductStru_PackingUpgradeApply_List.aspx.cs" Inherits="ProductStru_PackingUpgradeApply_List" %>
                ...
                <tr class="main_top">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; 状态：
                        <asp:DropDownList ID="ddl_status" runat="server">
                            ...
                            <asp:ListItem  Text="待BOM组确认版本"  Value="10"></asp:ListItem>
                            <asp:ListItem  Text="待包装组确认"  Value="20"></asp:ListItem>
                            <asp:ListItem  Text="待BOM组导入"  Value="30"></asp:ListItem>
            ...
            <asp:GridView ID="gvlist" name="gvlist" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                ...
                <Columns>
                   <asp:BoundField HeaderText="申请单号" DataField="Code">
                    ...
                    <asp:BoundField HeaderText="新整灯型号" DataField="prodcodenew">
                        <HeaderStyle Width="200px" />
                        <ItemStyle Width="200px" HorizontalAlign="Center" />
                    </asp:BoundField>
