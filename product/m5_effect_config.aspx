<%@ Page Language="C#" AutoEventWireup="true" CodeFile="m5_effect_config.aspx.cs" Inherits="product_m5_effect_config" %>
...
<body>
    ...
    <div align="center">        
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="确认项目："></asp:Label>
                </td>
                <td colspan="5">
        ...
        DataKeyNames="m5eu_effectid,m5eu_userid" onrowdeleting="gv_RowDeleting">
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="工号" DataField="m5eu_userNo">
                <HeaderStyle Width="100px" />
                <ItemStyle Width="100px" Height="25px" HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField HeaderText="姓名" DataField="m5eu_userName">
