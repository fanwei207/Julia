<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductStruApply_New.aspx.cs" Inherits="product_ProductStruApply_New" %>
        ...
        <table cellpadding="0" cellspacing="0" style="text-align: left">
            ...
            <tr>
                ...
                <td class="style1">
                    ...
                    <asp:LinkButton ID="linkProd" runat="server" OnClick="linkProd_Click">项目信息</asp:LinkButton>
                ...
                <td class="style3">
                    <asp:TextBox ID="txt_project" runat="server" Width="376px" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style1" align="right">
                ...
                <td class="style1">
                    <asp:TextBox ID="txt_projectCategory" runat="server" Width="149px"  ReadOnly="true"></asp:TextBox>
                </td>
                <td align="right">
                    项目描述：
                </td>
                <td class="style3">
                    <asp:TextBox ID="txt_prodDesc" runat="server" Width="376px" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
             ...
             <tr id="trUpload1" runat="server">
                ...
                <td align="left" colspan="2" width="135">
                    <label id="here" onclick="submit();">
                        <a href="/docs/ProductStruApplyTemplate.xls" target="blank"><font color="blue">导入产品文件的模版</font></a></label>
                </td>
                <td align="center">
            ...
            <tr>
                <td colspan="2" class="style2">
                    <asp:GridView ID="gv_product" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:BoundField DataField="type" HeaderText="产品类型" ReadOnly="true">
            ...
            <tr>
               <td align="left">
                ...
                <td align="right">
                    ...
                    <asp:Button OnClick ="likbtn_Click" ID ="btnExport" runat="server"  CssClass ="SmallButton2" Text ="导出"/>
