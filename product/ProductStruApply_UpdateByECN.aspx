<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductStruApply_UpdateByECN.aspx.cs" Inherits="ProductStruApply_UpdateByECN" %>
    ...
    <div align="center">
        <table cellpadding="0" cellspacing="0" style="text-align: left">
            ...
            <tr>
                ...
                <div id="dviecn" runat="server">
                <td class="style1">
                    <asp:TextBox ID="txt_ECNNO" runat="server" Width="149px"></asp:TextBox>
                </td>
                </div>
                <td align="left">
                    <asp:LinkButton ID = "txt_nbr1" runat="server"  Width="149px" ReadOnly="true" 
                        onclick="txt_nbr1_Click"></asp:LinkButton>
                </td>
                <td class="style3">
                </td>
            </tr>
            ...
            <tr id="trApply" runat="server">
                <td colspan="5" align="center">
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="btn_Submit" runat="server" Text="提交" Width="53px" OnClick="btn_Confirm_Click" CssClass="SmallButton2"/>
                    &nbsp;&nbsp;
            ...
            <tr id="trReview" runat="server">
                <td colspan="5" align="center">
                    <asp:Button ID="btn_Confirm" runat="server" Text="导入" Width="53px" OnClick="btn_Confirm_Click"
                        CssClass="SmallButton2" />
                    &nbsp;&nbsp;
                    <asp:Button ID="btn_Confirm1" runat="server" Text="审核" Width="53px" OnClick="btn_Confirm_Click"
                        CssClass="SmallButton2" />
                    &nbsp;&nbsp;
             ...
             <tr id="trUpload1" runat="server">
                ...
                <td align="left" colspan="2" width="135">
                    <label id="here" onclick="submit();">
                        <a href="/docs/ProductStruUpdateApplyTemplateByEcn.xls" target="blank"><font color="blue">导入产品修改文件的模版</font></a></label>
                </td>
                <td align="center">
            ...
            <tr>
                <td colspan="2" class="style2">
                    <asp:GridView ID="gv_det" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <HeaderStyle CssClass="GridViewHeaderStyle" />
                        <Columns>
                            <asp:BoundField DataField="producttop" HeaderText="TOP" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" Width="150px" />
                                <ItemStyle HorizontalAlign="Left" Width="150px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="producttopqad" HeaderText="QAD号" ReadOnly="true">
                                <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:BoundField>
