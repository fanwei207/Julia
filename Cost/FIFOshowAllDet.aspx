<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FIFOshowAllDet.aspx.cs" Inherits="EDI_FIFOshowAllDet" %>
                ...
                <tr class="main_top">
                    ...
                    <asp:TextBox ID="txtSOPO" runat="server" CssClass="smalltextbox Param" Width="104px"></asp:TextBox>
                        Type:
                         <asp:DropDownList ID="ddltype" runat="server">
                             ...
                             <asp:ListItem Value="1">已确定</asp:ListItem>
                    ...
                    <td align="right">
                        ...
                        <asp:Button ID="btnimport" runat="server" CssClass="SmallButton2" 
                            Text="导出" Width="50px" OnClick="btnimport_Click"   />
