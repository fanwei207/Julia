<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SampleDeliveryList.aspx.cs" Inherits="SampleDelivery_SampleDeliveryList" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btn_Back" runat="server" Text="返回" Visible="false"
                      ...
                      <asp:Button ID="btn_ulback" runat="server" Text="返回" Visible="false"
                        CssClass="SmallButton2"  Width="40px" OnClick="btn_ulback_Click"   />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:GridView ID="gv_mstr" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <EmptyDataTemplate>
                            <asp:Table ID="Table1" runat="server" CellPadding="-1" CellSpacing="0" Width="1070px"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="IsSended" HeaderText="发送">
                                <HeaderStyle HorizontalAlign="Center" Width="50px" />
                                <ItemStyle HorizontalAlign="Center" Width="50px" />
                            </asp:BoundField>
                              <asp:BoundField DataField="IsCanceled" HeaderText="状态">
                                <HeaderStyle HorizontalAlign="Center" Width="50px" />
                                <ItemStyle HorizontalAlign="Center" Width="50px" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="详细">
                                <ItemTemplate>
                                    <asp:LinkButton ID="linkDetail" runat="server" CommandName="Detail" Font-Underline="True"
                                        CommandArgument='<%# Eval("Id") %>' ForeColor="Black">详细</asp:LinkButton>
                                </ItemTemplate>
