<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SampleDeliverySendList.aspx.cs" Inherits="SampleDelivery_SampleDeliverySendList" %>
        ...
        <table width="1000px">
            <tr>
                <td>
                    ...
                    <asp:DropDownList ID="ddl_sendValue" runat="server" Width="84px">
                        <asp:ListItem Value="0" Selected="True">待发送</asp:ListItem>
                        ...
                        <EmptyDataTemplate>
                            <asp:Table ID="Table1" runat="server" CellPadding="-1" CellSpacing="0" Width="900px"
                                ...
                                <asp:TableFooterRow BackColor="white" ForeColor="Black">
                                    <asp:TableCell HorizontalAlign="Center" Text="没有记录" ColumnSpan="6"></asp:TableCell>
                                </asp:TableFooterRow>
                            </asp:Table>
                        </EmptyDataTemplate>
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="发送">
                                <ItemTemplate>
                                    <asp:LinkButton ID="linkDetail" runat="server" CommandName="Detail" Font-Underline="True"
                                        CommandArgument='<%# Eval("Id") %>' ForeColor="Black">发送</asp:LinkButton>
                                </ItemTemplate>
