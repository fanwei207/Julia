<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.soque_choose2" CodeFile="soque_choose2.aspx.vb" %>
    ...
    <table id="table1" cellpadding="0" cellspacing="0" width="400" align="center">
        ...
        <tr>
            <td>
                ...
                <input id="btn_ok1" value="To" class="SmallButton2" type="button" onclick="post()">
            </td>
        </tr>
        <tr>
