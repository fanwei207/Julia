        ...
        <table border="0" cellpadding="0" cellspacing="0" width="1050px">
            <tr>
                ...
                <td align="left" colspan="1" style="width: 100px; height: 27px">
                    创建人<asp:TextBox ID="txtCreatedName" runat="server" CssClass="SmallTextBox" Height="20px"
                ...
                <td align="left" colspan="1" style="width: 55px; height: 27px">
                    <asp:CheckBox ID="chkUnAccount" runat="server" Text="未结" Checked="True" />
                </td>
            ...
            <tr>
                ...
                <td align="left" colspan="1" style="width: 100px; height: 27px">
                    每页记录<asp:TextBox ID="txtPageSize" runat="server" CssClass="TextRight" Height="20px"
                ...
                <td align="right" style="width: 45px; height: 27px">
                    <asp:Button ID="btnApprove" runat="server" CausesValidation="False" CssClass="SmallButton3"
                        OnClick="btnApprove_Click" Text="审批" />
                </td>
            </tr>
        </table>
        <asp:GridView ID="gvlist" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <EmptyDataTemplate>
                <asp:Table ID="Table1" runat="server" CellPadding="-1" CellSpacing="0" CssClass="GridViewHeaderStyle"
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell HorizontalAlign="center" Text="审批" Width="50px"></asp:TableCell>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="审批">
                    <ItemTemplate>
                        <asp:LinkButton ID="linkApprove" Text="审批" ForeColor="Blue" Font-Underline="true"
                ...
                <asp:BoundField DataField="bo_sample" HeaderText="留样">
                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="bo_SampleNbr" HeaderText="留样单">
                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
            </Columns>
