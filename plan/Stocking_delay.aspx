<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Stocking_delay.aspx.cs" Inherits="plan_Stocking_delay" %>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="sk_EA" HeaderText="单位" ReadOnly="true">
                 ...
                 <asp:BoundField DataField="status" HeaderText="状态" ReadOnly="true">
                   ...
                   <asp:BoundField DataField="diday" HeaderText="延时时间" ReadOnly="true">
                    <HeaderStyle Width="70px" HorizontalAlign="Center" />
                    <ItemStyle Width="70px" HorizontalAlign="Center" />
                </asp:BoundField>
                 ...
                 <asp:TemplateField HeaderText="订单号">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtponbr" runat="server" CssClass="smalltextbox" MaxLength="50"
                                            Text='<%# Bind("order_Nbr") %>' Width="100%"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblponbr" runat="server" Text='<%# Bind("order_Nbr") %>'></asp:Label>
                                    </ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="订单行">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtpolinr" runat="server" CssClass="smalltextbox" MaxLength="50"
                                            Text='<%# Bind("order_line") %>' Width="100%"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblpoline" runat="server" Text='<%# Bind("order_line") %>'></asp:Label>
                                    </ItemTemplate>
