<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wo_firstInspection.aspx.cs" Inherits="plan_wo_firstInspection" %>
        ...
        <div align="center">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="供应商">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddladdr" runat="server"  Width="100%"></asp:DropDownList>
                        </ItemTemplate>
            ...
            <table border="0" width="780px" style="text-align: left;">
                <tr>
                    <td>备注：</td>
                    <td colspan="6">
                        <asp:TextBox ID="txtRmks" runat="server" Height="100px" Width="400px" TextMode="MultiLine" MaxLength="100" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
