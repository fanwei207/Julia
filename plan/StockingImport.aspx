<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockingImport.aspx.cs" Inherits="EDI_StockingImport" %>
            ...
            <fieldset style="width: 850px;">
                ...
                <table cellpadding="6" cellspacing="0" style="width: 827px;" border="0">
                    ...
                    <tr>
                        ...
                        <td valign="top" colspan="2" style="width: 826px">
                            <input id="filePo" style="width: 563px; height: 22px" type="file" name="filename1"
                                runat="server" />
                        </td>
                    </tr>
                    <tr>
