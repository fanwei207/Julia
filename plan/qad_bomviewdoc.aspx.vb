...
#End Region
        ...
        Private Sub GetBomFromQad(ByVal part As String, ByVal lel As Integer)
            ...
            While reader.Read()
                ...
                sql = sql & " where ps_domain='" & domain & "' and ps_par='" & bom_comp & "'"
        ...
        Sub BindData()
            ...
            strSql = " SELECT t.doc_bom_id,t.doc_bom_par,t.doc_bom_part,t.doc_bom_comp,i.code,t.doc_bom_lel,i.description,isnull(q.desc1,'')+isnull(q.desc2,'') " _
                   & " , t.doc_bom_qty, isDoc = Case When pti.itm_qad Is Null Then 0 Else 1 End , nullif(pt.pt_pur_lead,0) as pt_pur_lead" _
                   & " From tcpc0.dbo.doc_bom_temp t " _
                   & " Left Outer join tcpc0.dbo.items i on i.item_qad=t.doc_bom_comp " _
                   & " Left Outer join (select distinct pt_part as qad,pt_desc1 as desc1,pt_desc2 as desc2 from qad_data.dbo.pt_mstr) q on q.qad=t.doc_bom_comp  COLLATE DATABASE_DEFAULT " _
                   & " Left Outer Join ( " _
                   & "                      Select Distinct itm_qad " _
                   & "                      From tcpc0.dbo.ProductTrackingItem " _
                   & "                  ) pti On pti.itm_qad = t.doc_bom_comp " _
                   & " Left Outer Join ( " _
                   & "                      Select  pt_part,max(pt_pur_lead) as pt_pur_lead  " _
                   & "                      From QAD_Data.dbo.pt_mstr " _
                   & "                      Group by pt_part" _
                   & "                 ) pt on pt.pt_part = t.doc_bom_comp" _
        ...
        Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
            ...
            Me.Redirect("/plan/wo_actualReleaseEX.aspx?dom=" & Request("dom") & "&type=" & Request("type") & "&q=" & Request("q"))
