<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RP_editDeliverysAppv.aspx.cs" Inherits="Purchase_RP_editDeliverysAppv" %>
            ...
            <tr align="left">
                ...
                <td style="width: 600px; height: 20px;" align="right">
                    ...
                    <asp:Button ID="btn_Save" runat="server" CausesValidation="true" CssClass="SmallButton2"
                        OnClick="btn_Save_Click" Text="通过" ValidationGroup="validator" Width="50px" />
                    &nbsp;&nbsp; &nbsp;<asp:Button ID="btnPrint" runat="server" CausesValidation="true"
                        CssClass="SmallButton2" OnClick="btnPrint_Click" Text="不通过" ValidationGroup="validator"
                        Width="50px" />
                    &nbsp;&nbsp;
                    ...
                    <asp:GridView ID="dtgList" runat="server" Style="vertical-align: top" CssClass="GridViewStyle"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="prd_qty_sum" HeaderText="已送出">
                             ...
                             <asp:BoundField DataField="prd_qty_dev" HeaderText="送货数">
                                <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                <ItemStyle Width="60px" HorizontalAlign="Right" />
                            </asp:BoundField>
