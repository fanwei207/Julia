<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RP_deliverylistsAppv.aspx.cs" Inherits="Purchase_RP_deliverylistsAppv" %>
     ...
     <form id="form1" runat="server">
        ...
        <tr align="left">
            <td style="width: 880px; height: 10px;">
                ...
                </asp:DropDownList>&nbsp;<asp:Button ID="btn_search" runat="server" Text="查询" OnClick="btn_search_Click"
