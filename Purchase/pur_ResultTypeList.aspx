<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pur_ResultTypeList.aspx.cs" Inherits="pur_ResultTypeList" %>
    ...
    <div align="center">
        ...
        <table cellspacing="0" cellpadding="0" style="width: 930px" class="main_top">
            <tr align="left">
                ...
                <td width="90px">
                    <asp:Button ID="btn_valueAdd" Text="新增" runat="server" width="60px" 
                        onclick="btn_valueAdd_Click"/>
                </td>
<%--                <td width="90px">
        ...
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
            ...
            PageSize="20" DataKeyNames="pur_typeid,pur_proid,checkok,pur_typename,maxvalue" AllowPaging="True" 
...
<%--                <asp:BoundField HeaderText="类型名称" DataField="pur_typename" ReadOnly="True">
                ...
                <asp:TemplateField HeaderText="类型名称">
                    <ItemTemplate>
                        <asp:Label ID="lb_typename" runat="server" Text='<%# Bind("typename") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_typename" runat="server" MaxLength="20" Text='<%# Bind("typename") %>' Width="100%"></asp:TextBox>
                    </EditItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="最大分值">
                    <ItemTemplate>
                        <asp:Label ID="lb_score" runat="server" Text='<%# Bind("maxvalue") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
