<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vc_cate.aspx.cs" Inherits="vc_cate" %>
    ...
    <div align="center">
        ...
        <table cellspacing="0" cellpadding="0" style="width: 630px" class="main_top">
            <tr>
                ...
                <td>
                    科目:<asp:TextBox 
                        ID="txtName" runat="server" Width="300px" CssClass="SmallTextBox" 
        ...
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
            ...
            PageSize="20" DataKeyNames="vcc_id" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="罚款科目">
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("vcc_name") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txDesc" runat="server" MaxLength="20" 
                            Text='<%# Bind("vcc_name") %>' Width="100%"></asp:TextBox>
                    </EditItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" Width="400px" />
                    <ItemStyle HorizontalAlign="Left" Width="400px" />
                </asp:TemplateField>
                <asp:BoundField HeaderText="创建人" DataField="vcc_createName" ReadOnly="True">
