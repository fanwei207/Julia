<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pur_ResultCheck.aspx.cs" Inherits="pur_ResultCheck" %>
    ...
    <div align="center">
        ...
        <table cellspacing="0" cellpadding="0" style="width: 930px" class="main_top">
            <tr>
                ...
                <td width="60px">
                    <asp:Label ID="Label1" Text="审批状态" runat="server"></asp:Label>
                </td>
                <td width="60px">
                ...
                <td width="80px">
                    <asp:Button ID="btn_check" runat="server" CssClass="SmallButton3" OnClick="btn_check_Click"
                        TabIndex="0" Text="通过" />
                </td>
                <td width="80px">
        ...
        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
            ...
            PageSize="20" DataKeyNames="pur_id,prh_vend,pur_year,pur_mounth" AllowPaging="True" 
            ...
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                        <%--<input id="chkAll" type="checkbox" OnCheckedChanged="chkAll_CheckedChanged">--%>
                        <asp:CheckBox ID="chkAll" runat="server" AutoPostBack="True" OnCheckedChanged="chkAll_CheckedChanged" />
                    </HeaderTemplate>
                    <ItemTemplate>
                        <%--<asp:CheckBox ID="chk" runat="server"/>--%>
                        <input id="chkImport" type="checkbox" name="chkImport" runat="server" value='<%#Eval("pur_id") %>' />
                    </ItemTemplate>
...
<%--                <asp:BoundField HeaderText="是否寄售得分" DataField="pur_consignScore" ReadOnly="True">
                ...
                <asp:BoundField HeaderText="价格水平得分" DataField="pur_priceScore" ReadOnly="True">
                    <HeaderStyle HorizontalAlign="Center" Width="60px" />
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                </asp:BoundField>
                ...
                <asp:BoundField HeaderText="样品交付得分" DataField="pur_samplePassScore" ReadOnly="True">
                    <HeaderStyle HorizontalAlign="Center" Width="60px" />
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                </asp:BoundField>
