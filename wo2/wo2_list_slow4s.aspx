<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wo2_list_slow4s.aspx.cs"
    Inherits="wo2_list_slow4s" %>
...
<body>
    <div align="center">
            ...
            <tr>
                <td>
                    日期:<asp:TextBox ID="txtDate1" 
                        runat="server" CssClass="SmallTextBox Date Param" MaxLength="10"
                        Width="80px"></asp:TextBox>—<asp:TextBox ID="txtDate2" runat="server" CssClass="SmallTextBox Date Param"
                            MaxLength="10" Width="80px"></asp:TextBox>&nbsp; 成本中心:<asp:TextBox ID="txtCostCenter"
                                runat="server" CssClass="SmallTextBox" MaxLength="4" Width="50px"></asp:TextBox>工单号:<asp:TextBox
                                    ID="txtNbr" runat="server" CssClass="SmallTextBox" MaxLength="15" Width="90px"></asp:TextBox>&nbsp;
                    ID号:<asp:TextBox ID="txtLot" runat="server" CssClass="SmallTextBox Param" MaxLength="15"
                        Width="90px"></asp:TextBox>
                    QAD号:<asp:TextBox ID="txtPart" runat="server" CssClass="SmallTextBox Part Param" MaxLength="15"
                        Width="100"></asp:TextBox>&nbsp;<asp:CheckBox ID="chkIsClosed" 
                        runat="server" Text="已结算" CssClass="Param" />
                    <asp:CheckBox ID="chkIsReported" runat="server" Text="已汇报" CssClass="Param" />
                </td>
                <td>
        ...
        <asp:GridView ID="gvSummary" runat="server" AutoGenerateColumns="False" AllowPaging="True"
            ...
            OnRowCommand="gvSummary_RowCommand" Width="960px" CssClass="GridViewStyle GridViewRebuild">
