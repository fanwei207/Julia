<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wo2_workhoursdisplay2Hist.aspx.cs"
    Inherits="Wo2_workhoursdisplay2Hist" %>
...
<body>
    <div align="center">
        ...
        <asp:GridView ID="gvUsers" AllowPaging="True" AutoGenerateColumns="False" CssClass="GridViewStyle AutoPageSize"
            runat="server" PageSize="18" Width="1150px" OnPageIndexChanging="gvUsers_PageIndexChanging"
