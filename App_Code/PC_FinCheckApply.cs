...
/// </summary>
public class PC_FinCheckApply
{
    private static adamClass adm = new adamClass();

	public PC_FinCheckApply()
	{
		//
    ...
    public DataTable GetPartCheckPriceFinishedList(string part, string itemCode, string vender, string venderName)
    {
        string strName = "sp_pc_selectCheckPriceFinishedForPart";
        SqlParameter[] parm = new SqlParameter[4];
        parm[0] = new SqlParameter("@part", part);
        parm[1] = new SqlParameter("@ItemCode", itemCode);
        parm[2] = new SqlParameter("@vender", vender);
        parm[3] = new SqlParameter("@venderName", venderName);
    ...
    {
        string strName = "sp_pc_selectFinCheckApplyPart";
    ...
    {
        string strName = "sp_pc_selectFinCheckApply";
    ...
    {
        string strName = "sp_pc_selectFinCheckApplyDet";
        SqlParameter[] parm = new SqlParameter[1];
        parm[0] = new SqlParameter("@ApplyId", id);
        return SqlHelper.ExecuteDataset(adm.dsn0(), CommandType.StoredProcedure, strName, parm).Tables[0];
    }
    ...
    public DataTable GetApplyDet(DataTable partTable)
    {
        ...
        string strName = "sp_pc_selectFinCheckApplyDetForNew";
        SqlParameter[] parm = new SqlParameter[1];
    ...
    {
        string strName = "sp_pc_selectFinCheckApprove";
        SqlParameter[] parm = new SqlParameter[1];
    ...
    public int AddApply(string approveBy, string applyReason, string applyBy, DataTable detail)
    {
        ...
        return Convert.ToInt32(SqlHelper.ExecuteScalar(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_insertFinCheckApply", param));
    }
    ...
    public void UpdateApplyDet(DataTable detail)
    {
        ...
        SqlHelper.ExecuteNonQuery(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_batchUpdateFinCheckApplyDet", sqlParam);
    }
    ...
    public bool Approve(string applyId, string approveBy, string uId, string approveOpinion, bool appoveresult)
    {
        ...
        return Convert.ToBoolean(SqlHelper.ExecuteScalar(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_updateFinCheckApprove", param));
    ...
    public bool Pass(string applyId, string approveBy, string uId, string approveOpinion)
    {
        ...
        param[2] = new SqlParameter("@uId", uId);
        param[3] = new SqlParameter("@approveOpinion", approveOpinion);
        return Convert.ToBoolean(SqlHelper.ExecuteScalar(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_PassFinCheckApprove", param));
    }
    ...
    public DataTable GetApplyList(string itemCode, string part, string applyDate, bool pendingToAppr, string userId, string roleId)
    {
        ...
        return SqlHelper.ExecuteDataset(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_selectFinCheckApplyList", param).Tables[0];
    }
    ...
    public DataTable GetFinPrice(string itemCode, string part, string vender, int type, string status)
    {
        ...
        return SqlHelper.ExecuteDataset(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_selectApplyDetForFin", param).Tables[0];
    }
    ...
    public void FinCancel(DataTable detail, int type)
    {
        ...
        SqlHelper.ExecuteNonQuery(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_updateApplyDetForFinCancel", sqlParam);
    }

    public string FinHandle(DataTable detail, int type)
    {
        StringWriter writer = new StringWriter();
        detail.WriteXml(writer);
        string xmlDetail = writer.ToString();
        ...
        sqlParam[0] = new SqlParameter("@detail", xmlDetail);
        sqlParam[1] = new SqlParameter("@type", type);
        DataTable dtUsers = SqlHelper.ExecuteDataset(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_updateApplyDetForHandle", sqlParam).Tables[0];

        if (dtUsers.Rows[0][0].ToString() == "-1" && type == 2)
        {
            return "核价";
        }
        else if (dtUsers.Rows[0][0].ToString() != "0" && type==2)
        {
        ...
        else if (dtUsers.Rows[0][0].ToString() != "0" && type == 1)
        {
    ...
    private DataSet GetCimloadData(DataTable detail, int type)
    {
        ...
        sqlParam[0] = new SqlParameter("@detail", xmlDetail);
        sqlParam[1] = new SqlParameter("@type", type);
        return SqlHelper.ExecuteDataset(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_selectApplyDetForCimload", sqlParam);
    }
    ...
    private DataTable GetCostCimloadData(DataTable detail)
    {
        ...
        SqlParameter[] sqlParam = new SqlParameter[1];
        sqlParam[0] = new SqlParameter("@detail", xmlDetail);
        return SqlHelper.ExecuteDataset(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_selectApplyDetForCost", sqlParam).Tables[0];
    }
    ...
    private bool SendMail(string toEmailAddress, string strApproverName, string applyEmailAddress, string applyName,string mailBody, out string returnMessage)
    {
        ...
        try
        {
            mail.Subject = "[Notify]核价审批" + "  from:" + strApproverName;
            mail.Body = mailBody;
    ...
    {
        string sqlstr = "sp_pc_selectApplyDetByDetID";
    ...
    {
        string sqlstr = "sp_pc_updateApplyDetToPindings";
    ...
    {
        string sqlstr = "sp_pc_selectFinCheckDayList";
        SqlParameter[] param = new SqlParameter[]{
    ...
    {
        string sqlstr = "sp_pc_selectFinCheckDayDet";
        SqlParameter[] param = new SqlParameter[]{
        new SqlParameter("@date",date)
        ,new SqlParameter("@vender",vender)
        };
    ...
    {
        string sqlstr = "sp_pc_selectInfoToCloseAppv";
    ...
    public int appvCloce(string DetID, int uID,string closeReason,int isdelete )
    {
        string sqlstr = "sp_pc_appvCloce";
        SqlParameter[] param = new SqlParameter[]{
        new SqlParameter("@DetID",DetID)
        ,new SqlParameter("@uID",uID)
    ...
    public DataTable selectFinCheckToExport(string applyID)
    {
        try
        {
            string sqlstr = "sp_pc_selectFinCheckToExport";
            ...
            if (success)
            {
                try
                {
                    ...
                    if (
                        ...
                        dt.Columns[3].ColumnName != "部件号" ||
                        dt.Columns[4].ColumnName != "供应商" ||
                        dt.Columns[5].ColumnName != "供应商名称" ||
                        ...
                        if (ClearFinCheckPriceTempTable(Convert.ToInt32(strUID)))
                        {
                            ...
                            for (int i = 0; i <= dt.Rows.Count - 1; i++)
                            {
                                ...
                                if (dt.Rows[i].IsNull(0) && dt.Rows[i].IsNull(1) && dt.Rows[i].IsNull(2)
                                    ...
                                    && dt.Rows[i].IsNull(9) && dt.Rows[i].IsNull(10) 
                                    )
                                {
                                    continue;
                                }
                                ...
                                TempRow["Vender"] = dt.Rows[i].ItemArray[4].ToString().Trim();
                                TempRow["VenderName"] = dt.Rows[i].ItemArray[5].ToString().Trim();
                                TempRow["um"] = dt.Rows[i].ItemArray[6].ToString().Trim();
                                TempRow["curr"] = dt.Rows[i].ItemArray[7].ToString().Trim();
                            ...
                            if (TempTable != null && TempTable.Rows.Count > 0)
                            {
                                ...
                                {
                                    bulkCopy.DestinationTableName = "pc_uploadFinCheckPriceTemp";
    ...
    private bool TransFinCheckPriceTempTable(int uID, string ApplyId)
    {
        try
        {
            string sqlstr = "sp_pc_TransFinCheckPriceTempTable";
    ...
    private bool JudgeFinCheckPriceTempTable(int uID, string ApplyId)
    {
        try
        {
            string sqlstr = "sp_pc_JudgeFinCheckPriceTempTable";
    ...
    private bool CheckFinCheckPriceTempTable(int uID, string ApplyId)
    {
        try
        {
            string sqlstr = "sp_pc_checkFinCheckPriceTempTable";
    ...
    private bool ClearFinCheckPriceTempTable(int uID)
    {
        try
        {
            string strsql = "sp_pc_ClearFinCheckPriceTempTable";

            SqlParameter[] param = new SqlParameter[]{
                new SqlParameter("@uiD",uID)
            };

            return Convert.ToBoolean(SqlHelper.ExecuteScalar(adm.dsn0(), CommandType.StoredProcedure, strsql, param));
        }
        catch (Exception ex)
        {
            return false;
    ...
    public DataTable GetInquiryPriceImportError(string uID, string ApplyId)
    {
        try 
        {
            string sqlstr = "sp_pc_GetInquiryPriceImportError";
    ...
    public bool AddApplyToCheck(DataTable table, string uID)
    {
        StringWriter writer = new StringWriter();
        ...
        return Convert.ToBoolean(SqlHelper.ExecuteScalar(adm.dsn0(), CommandType.StoredProcedure, "sp_pc_addApplyToCheck",param));
