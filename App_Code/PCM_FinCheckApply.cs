...
public class PCM_FinCheckApply
{
    ...
    public DataTable GetPartCheckPriceFinishedList(string part, string itemCode,  string vender, string inquiry , string venderName)
    {
        ...
        parm[3] = new SqlParameter("@inquiry", inquiry);
        parm[4] = new SqlParameter("@venderName", venderName);
  ...
  ;
    ...
    public bool AddApplyToCheck(DataTable table, string uID)
    {
        ...
        return Convert.ToBoolean(SqlHelper.ExecuteScalar(adm.dsn0(), CommandType.StoredProcedure, "sp_pcm_addApplyToCheck", param));
    }
}