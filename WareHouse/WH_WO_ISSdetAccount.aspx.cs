...
using System.Text;
using WHInfo;
public partial class plan_WH_WO_ISSdetAccount : System.Web.UI.Page
{
    ...
    {
        string strName = "sp_Wh_cimloadWod";
        SqlParameter[] parm = new SqlParameter[3];
        parm[0] = new SqlParameter("@nbr", nbr);
        parm[1] = new SqlParameter("@domain", domain);
        parm[2] = new SqlParameter("@lot", lot);
    ...
    protected void btn_update_Click(object sender, EventArgs e)
    {
        ...
        string path_szx = root + domain + DateTime.Now.ToString("yyyyMMddhhmmssfff") + ".wod";
        try
        {
    ...
    public static bool updatetwhView(string nbr, string domain, string lot)
    {
        try
        {
            string strName = "sp_wh_updatewhWO_ISSAccount";
            SqlParameter[] parm = new SqlParameter[3];
            parm[0] = new SqlParameter("@nbr", nbr);
            parm[1] = new SqlParameter("@domain", domain);
            parm[2] = new SqlParameter("@lot", lot);
