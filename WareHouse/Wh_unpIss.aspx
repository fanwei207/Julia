<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wh_unpIss.aspx.cs" Inherits="WareHouse_Wh_unpIss" %>
        ...
        <div align="center">
            <table width="980px" id="tb">
                ...
                <tr align="left">
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txt_no" Width="120px" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
                <tr align="left">
                    <td>项目类型</td>
            ...
            <asp:GridView runat="server" ID="gv" ShowFooter="true" Width="700px" AutoGenerateColumns="False" DataKeyNames ="wh_part,wh_mstrID,rowNum" OnRowDataBound="gv_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="单位">
                        ...
                        <FooterTemplate>
                            <asp:DropDownList ID="ddl_um" runat="server" Width="50px" DataSource='<%# ddlbindUM()%>' DataValueField="code_value" DataTextField="code_value" >
                                <asp:ListItem Value="EA" Selected="True">EA</asp:ListItem>
