<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WH_UNP_RCTdet.aspx.cs" Inherits="WH_UNP_RCTdet" %>
        ...
        <div align="Center">
            <table width="980px" id="tb">
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <asp:TextBox ID="txt_reason" runat="server" TextMode="MultiLine" Width="500px" Height="50px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td colspan="5">
                        <asp:TextBox runat="server" ID="txt_backreason" Width="500px" Height="160px" TextMode="MultiLine" Visible="false" MaxLength="200"></asp:TextBox>
                    </td>             
                </tr>
            </table>
            <asp:GridView runat="server" ID="gv" ShowFooter="true" Width="980px" AutoGenerateColumns="False" DataKeyNames ="wh_part,rowNum,wh_id" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="实收数量">
                        <ItemTemplate>
                            <asp:Label ID="lblactualQty" Text='<%# Eval("wh_actualQty") %>' runat="server" onkeyup='this.value=this.value.replace(/[^0-9.]/gi,"")' MaxLength="10" ></asp:Label>
                        </ItemTemplate>
