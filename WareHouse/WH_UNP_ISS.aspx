<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WH_UNP_ISS.aspx.cs" Inherits="WH_UNP_ISS" %>
        ...
        <div align="Center">
            <table width="980px" id="tb">
                <tr align="left">
                    ...
                    <td align="left">
                        <asp:Button ID="btn_submit" runat="server" Text="提交" OnClick="btn_submit_Click" Width="69px" Height="36px" />
                    </td>
                </tr>
                <tr align="left">
