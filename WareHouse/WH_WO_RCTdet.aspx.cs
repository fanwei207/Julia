...
public partial class plan_WH_WO_ISSdet : BasePage
{
    ...
    {
        DataTable dt = GetWhViewDet(nbr, domain, lot);
        ...
        gv.DataSource = GetWhView(nbr, domain, lot);
        gv.DataBind();
    }
    ...
    public static bool updatetwhView(string nbr, string domain, string lot)
    {
        try
        {
            string strName = "sp_wh_updatewhWO_RCT";
            SqlParameter[] parm = new SqlParameter[3];
            parm[0] = new SqlParameter("@nbr", nbr);
            parm[1] = new SqlParameter("@domain", domain);
            parm[2] = new SqlParameter("@lot", lot);
    ...
    protected void btn_cancel_Click(object sender, EventArgs e)
    {
        ...
        string strName = "sp_wh_cancelwhWO_RCT";
