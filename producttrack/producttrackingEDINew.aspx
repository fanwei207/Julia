<%@ Page Language="C#" AutoEventWireup="true" CodeFile="producttrackingEDINew.aspx.cs"
    Inherits="producttrackingEDINew" %>
...
<body>
    <div align="left">
            ...
            <tr>
                <td>
                    QAD：<asp:TextBox ID="txtQad" runat="server" Width="120px" 
                       ...
                       客户物料：<asp:TextBox ID="txtpart" runat="server" Width="120px" 
                        TabIndex="3" Height="22"
                         CssClass="SmallTextBox Part Param"></asp:TextBox>
        ...
        <asp:GridView ID="gv" runat="server" OnRowDataBound="gv_RowDataBound"
            ...
            DataKeyNames="qadPart" onrowcommand="gv_RowCommand" 
            ...
            <Columns>
                ...
                <ItemStyle Width="50px" HorizontalAlign="Center" />
                 ...
                 <asp:BoundField DataField="partNbr" HeaderText="客户物料" >
                ...
                <asp:TemplateField HeaderText="QAD">
                    <ItemTemplate>
                        <asp:LinkButton ID="linkQad" runat="server" CommandName="Link" 
                            Font-Underline="True" Text='<%# Bind("qadPart") %>'></asp:LinkButton>
                    </ItemTemplate>
