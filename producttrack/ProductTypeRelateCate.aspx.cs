...
public partial class ProductTrakingType : BasePage
{
    ...
    private SqlDataReader GetProductTrackingTypeByID(int id)
    {
        ...
        return SqlHelper.ExecuteReader(strConn, CommandType.StoredProcedure, "sp_selectProductTrackingTypeByID", param);
    }
    ...
    private int InsertProTypeRelateCate(int ptt_id, int type_id, int cate_id, int createBy, string createName)
    {
        ...
        SqlHelper.ExecuteNonQuery(strConn, CommandType.StoredProcedure, "sp_InsertProTypeRelateCate", param);
    ...
    private void BindData()
    {
        ...
        DataTable dt = SqlHelper.ExecuteDataset(strConn, CommandType.StoredProcedure, "sp_SelectProTypeRelateCate", param).Tables[0];
        gv.DataSource = dt;
        gv.DataBind();
    }
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "MyDelete")
        {
            ...
            string strSql = "delete from qaddoc.dbo.ProTypeRelateCate where ptt_id =" + ptt_id + "and cate_id =" + cate_id;
            SqlHelper.ExecuteNonQuery(strConn, CommandType.Text, strSql);
    ...
    {
        Response.Redirect("ProductTrakingType.aspx?rm=" + DateTime.Now, true);
    }
}