<%@ Page Language="C#" AutoEventWireup="true" CodeFile="producttrackingsoNew.aspx.cs"
    Inherits="producttrackingso" %>
    ...
    <div align="left">
        ...
        <table id="table1" cellspacing="0" cellpadding="0">
            <tr>
                <td>
                    &nbsp;域：<asp:DropDownList 
                        ID="dropDomain" runat="server" Width="60px" DataTextField="ptt_type" 
                    ...
                    -<asp:TextBox ID="txtNbr2" runat="server" Width="70px" 
                        TabIndex="3" Height="22"
                        MaxLength="8" CssClass="SmallTextBox Param"></asp:TextBox>
                    &nbsp;截至日期：<asp:TextBox ID="txtDueDate1" runat="server" Width="70px" 
                        TabIndex="3" Height="22"
                ...
                <asp:TemplateField HeaderText="QAD">
                    <ItemTemplate>
                        <asp:LinkButton ID="linkQad" runat="server" CommandName="Link" 
                            Font-Underline="True" Text='<%# Bind("sod_part") %>'></asp:LinkButton>
                    </ItemTemplate>
