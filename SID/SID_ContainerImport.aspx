<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SID_ContainerImport.aspx.cs"
    Inherits="SID_ContainerImport" %>
...
<body>
    <div align="center">
        ...
        <table cellpadding="6" cellspacing="0" width="780" class="main_import">
            <tr>
                <td colspan="3" class="main_import_img"><b>出运单导入</b></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" style="width: 135">
                    <label id="here" onclick="submit();">
                        <a href="/docs/SID_ContainerImport.xls" target="blank"><font color="blue">导入模版</font>
                        </a>
                    </label>
                </td>
                <td align="center">
                    <input class="SmallButton2" id="BtnImport" style="width: 120px" type="button" value="导入对应集装箱号"
                        name="BtnImport" runat="server" onserverclick="BtnImport_ServerClick" />
                </td>
            </tr>
        </table>
        </form>
