<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SID_shipdetailForFin.aspx.cs" Inherits="SID_shipdetailForFin" %>
    ...
    <div align="left">
        ...
        <asp:GridView ID="gvShipdetail" runat="server" AutoGenerateColumns="False" DataKeyNames="DID,SID_org_con"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="so_nbr" HeaderText="销售订单1" ReadOnly="True">
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                    <HeaderStyle Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="so_line" HeaderText="行号1" ReadOnly="True">
                    <ItemStyle HorizontalAlign="Center" Width="40px" />
                    <HeaderStyle Width="40px" />
                </asp:BoundField>
                <asp:BoundField DataField="sod__qadc03" HeaderText="销售订单2" ReadOnly="True">
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                    <HeaderStyle Width="60px" />
                </asp:BoundField>
                <asp:BoundField DataField="sod__qadi01" HeaderText="行号2" ReadOnly="True">
                    <ItemStyle HorizontalAlign="Center" Width="40px" />
                    <HeaderStyle Width="40px" />
                </asp:BoundField>
                <asp:BoundField DataField="wo_site" HeaderText="制地" ReadOnly="True">
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                    <HeaderStyle Width="60px" />
                </asp:BoundField>
