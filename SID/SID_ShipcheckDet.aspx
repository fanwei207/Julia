<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SID_ShipcheckDet.aspx.cs" Inherits="SID_SID_ShipcheckDet" %>
        ...
        <asp:GridView ID="gvShipdetail" runat="server" AutoGenerateColumns="False" DataKeyNames="DID,SID_org_con"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="atl" HeaderText="ATL订单" ReadOnly="True">
                 ...
                 <asp:BoundField DataField="sid_checkeddate" HeaderText="货物抵达时间" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}"
                    HtmlEncode="False">
                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                </asp:BoundField>
