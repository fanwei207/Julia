<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SID_PackingReport.aspx.cs" Inherits="SID_PackingList1" %>
...
<body>
    <div align="center">
        ...
        <table cellspacing="0" cellpadding="0" width="990px" border="0" >
            <tr>
                ...
                <td align="Left" width="255px">
                    &nbsp;<asp:Button ID="btn_packingexport" runat="server"
            ...
            <tr>
                ...
                <td align="left">
                 ...
                 <td align="center">
                    <asp:Label ID="Label6" runat="server" Width="55px" CssClass="LabelRight" Text="发票日期:"
                        Font-Bold="false"></asp:Label>
                </td>
                <td align="left" width="170px">
                    <asp:TextBox ID="txt_packingdate1" runat="server" CssClass="smalltextbox Date" TabIndex="3"
                        Width="80px"></asp:TextBox>-<asp:TextBox ID="txt_packingdate2" runat="server" CssClass="smalltextbox Date"
                            TabIndex="3" Width="80px"></asp:TextBox>
                </td>   
        ...
        <asp:GridView ID="gvPacking" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="true"
            ...
            DataKeyNames="pk" OnPageIndexChanging="gvPacking_PageIndexChanging"
