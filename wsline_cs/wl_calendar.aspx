                ...
                <td>
                    &nbsp;<asp:DropDownList ID="ddl_site" runat="server" Width="100px" AutoPostBack="True"
                        OnSelectedIndexChanged="ddl_site_SelectedIndexChanged">
                         <asp:ListItem Selected="true" Value="1">上海强凌 SQL</asp:ListItem>
                    ...
                    <asp:CheckBox ID="chk_multi" runat="server" Text="显示分段" AutoPostBack="true" Checked="false"
                    ...
                    <td align="right">
                        ...
                        <asp:Button ID="btn_list" runat="server" Width="30" CssClass="SmallButton3" Text="刷新"
                        ...
                        <asp:Button ID="btn_detail" runat="server" Width="30" CssClass="SmallButton3" Text="原始"
                            TabIndex="4" OnClick="btn_detail_Click"></asp:Button>&nbsp;
                        <asp:Button ID="btn_repeat" runat="server" Width="30" CssClass="SmallButton3" Text="多段"
                            TabIndex="4" OnClick="btn_repeat_Click"></asp:Button>&nbsp;
                    </td>
                    <td>
                    <asp:Button ID="btn_exportAll" runat="server" Width="80px" Visible="false" 
                        CssClass="SmallButton3" Text="导出所有" onclick="btn_exportAll_Click" />
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                        <asp:Button ID="btn_listNew" runat="server" Width="60px" CssClass="SmallButton3" Text="刷新（新）"
        ...
        <asp:GridView ID="gvBadProd" runat="server" AllowPaging="true" CssClass="GridViewStyle GridViewRebuild"
            ...
            <EmptyDataTemplate>
                <asp:Table ID="Table1" Width="1120px" CellPadding="0" CellSpacing="0" runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell Text="成本中心" Width="150px" HorizontalAlign="center"></asp:TableCell>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="group_atten2" HeaderText="考勤小时2">
                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="group_starttime" HeaderText="实际上班时间">
                    <HeaderStyle Width="150px" HorizontalAlign="Center" />
                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="group_endtime" HeaderText="实际下班时间">
                    <HeaderStyle Width="150px" HorizontalAlign="Center" />
                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                </asp:BoundField>
            </Columns>
