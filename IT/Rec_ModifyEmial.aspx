<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rec_ModifyEmial.aspx.cs" Inherits="IT_Rec_ModifyEmial" %>
        ...
        <table id="table1" cellpadding="0" cellspacing="0" width="400" align="center">
            ...
            <tr>
                <td colspan="2" style="height: 24px">
                    <asp:TextBox ID="txtUserEmls" runat="server" Width="400px" Visible="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    <br />
                    <asp:Button ID="BtnSave" runat="server" Text="Save" CssClass="SmallButton2" Width="50"
