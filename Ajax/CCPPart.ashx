<%@ WebHandler Language="C#" Class="CCPPart" %>
...
public class CCPPart : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string plantCode = context.Session["PlantCode"].ToString();
        if (_plantCode == "1")
            _plantCode = "SZX";
        ...
        strSql += " Where pt_part LIKE '[5678]%' And pt_domain = '" + _plantCode + "'";
        strSql += "     And (pt_part Like '" + _part + "%' Or pt_desc1 Like N'%" + _part + "%' Or pt_desc2 Like N'%" + _part + "%') and  pt_status<>'STOP'  ";
