<%@ WebHandler Language="C#" Class="UserDomain" %>
...
/// <summary>
/// 和User类似。只不过，UserDomain拉取的用户要区分域
/// </summary>
public class UserDomain : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        strSql += "	        And (userNo Like '" + _user + "%' Or userName Like N'" + _user + "%')";

        IList<UserDomainCell> list = new List<UserDomainCell>();
        ...
        {            
            ...
            if (table != null && table.Rows.Count > 0)
            {
                ...
                {
                    UserDomainCell item = new UserDomainCell();
