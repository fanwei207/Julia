<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.ws_display" CodeFile="ws_display.aspx.vb" %>
    ...
    <script type="text/javascript"> 
        ...
        function beginrefresh() {
            if (!document.images)
                return
            if (parselimit == 1)
                window.location.href = "ws_display.aspx?dd=" + document.getElementById("txb_date").value + "&site=" + document.getElementById("ddl_site").value + "&cc=" + document.getElementById("ddl_cc").value + "&line=" + document.getElementById("ddl_line").value + "&part=" + document.getElementById("txb_part").value;
            else {
                parselimit -= 1
                /*
...
<body>
    <div align="center">
        ...
        <asp:DataGrid ID="Datagrid1" runat="server" Width="980px" AutoGenerateColumns="False"
            ...
            <ItemStyle CssClass="GridViewStyle" />
