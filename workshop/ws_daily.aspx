...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.ws_daily" CodeFile="ws_daily.aspx.vb"
    ...
    <script> 
        ...
        function beginrefresh() {
            if (!document.images)
                return
            if (parselimit == 1)
                window.location.href = "/workshop/ws_daily.aspx?dd=" + document.getElementById("txb_date").value + "&site=" + document.getElementById("ddl_site").value + "&cc=" + document.getElementById("ddl_cc").value + "&line=" + document.getElementById("ddl_line").value + "&part=" + document.getElementById("txb_part").value;
            else {
                parselimit -= 1
                /*
