...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.ws_anal41" CodeFile="ws_anal41.aspx.vb"
...
//with (_DiagramTarget.document)
{
	...
	D.SetBorder(0,12, 0, high);
	D.SetText("<%=ddl_type.SelectedItem.text%>","合格率", "日期范围内各月的平均合格率曲线图");
	//D.XScale="%";
	//D.YScale="%";
	...
	j=D.ScreenX(0)+610;
	new Bar(j, y0-10, j+220, y0+10, '', '月', '#663300');
...
//with (_DiagramTarget.document)
{
	...
	D.SetBorder(0,12, 0, high);
	D.SetText("<%=ddl_type.SelectedItem.text%>","流量", "日期范围内各月的平均流量曲线图");
	//D.XScale="%";
	//D.YScale="%";
    //	D.Draw("#FFEECC", "#663300", false);
	//D.Draw("#FFFFFF", "#663300", false, "Click here to refresh graph", "DiagramClick()");
