...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.ws_anal31" CodeFile="ws_anal31.aspx.vb"
    ...
    <div align="center">
        ...
        <asp:Panel ID="Panel2" runat="server" Width="980px" HorizontalAlign="Left" BorderWidth="1px"
            ...
            <table id="table1" cellspacing="0" cellpadding="0" width="980">
                <tr>
                    <td>
                        &nbsp;日期<asp:TextBox ID="txb_date" runat="server" Width="70" TabIndex="3" Height="22"></asp:TextBox><asp:TextBox
...
//with (_DiagramTarget.document)
{
	...
	D.SetBorder(0,52, 0, high);
	D.SetText("<%=ddl_type.SelectedItem.text%>","合格率", "日期范围内各周的平均合格率曲线图");
	//D.XScale="%";
	//D.YScale="%";
	...
	j=D.ScreenX(0)+610;
	new Bar(j, y0-10, j+220, y0+10, '', '周', '#663300');
...
//with (_DiagramTarget.document)
{
	...
	D.SetBorder(0,52, 0, high);
	D.SetText("<%=ddl_type.SelectedItem.text%>","流量", "日期范围内各周的平均流量曲线图");
	//D.XScale="%";
	//D.YScale="%";
    //	D.Draw("#FFEECC", "#663300", false);
	//D.Draw("#FFFFFF", "#663300", false, "Click here to refresh graph", "DiagramClick()");
