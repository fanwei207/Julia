<%@ WebHandler Language="C#" Class="custbondc" %>
...
public class custbondc : IHttpHandler, IRequiresSessionState {
    ...
    string bstatus = context.Request["bstatus"];
	 ...
	 //hi_date
      ...
      {    
            ...
            param[0] = new SqlParameter("@number", number);
            ...
            DataTable _Table = SqlHelper.ExecuteDataset(strConn, CommandType.StoredProcedure, "sp_custbond_track", param).Tables[0];
