<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wo2_completedandreported.aspx.cs"
    Inherits="wo2_completedandreported" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#container').highcharts({
                ...
                tooltip: {
                    pointFormat: '<span style="color:{series.color}">{series.name}</span>: <b>{point.percentage:.1f}%</b> ({point.y:,.0f} EA)<br/>',
                    shared: true
                },
                plotOptions: {
                    area: {
...
<body>
    ...
    <div>
        <div>
            ...
            &nbsp; <strong>统计科目</strong>：统计各地一个月内，已入库工单中，按时汇报工单数，和未按时汇报的工单数分布情况。没有当天汇报（诸如补汇报）的，则自动过滤。</div>
