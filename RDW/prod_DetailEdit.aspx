<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prod_DetailEdit.aspx.cs" Inherits="RDW_prod_DetailEdit" %>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        $(function(){
            ...
            $("#btnTrack").click(function(){
                ...
                var _src = "/RDW/prod_Report.aspx?code=" + _projCode + "&mid=" +　_mid　+ "&did=" +　_did + "&name=" + _projName;
                $.window("样品试流申请单列表", "90%", "90%", _src, "", true);
            ...
            <tr>
                ...
                <td align="left" colspan="7">
                    <asp:TextBox ID="txtStepData" runat="server" CssClass="TextLeft" TextMode="MultiLine"
                        Width="500px" BorderWidth="0px" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right" class="style1">
                ...
                <td align="left" colspan="3">
                    <asp:Label ID="lblStepStartData" runat="server" CssClass="LabelLeft" Font-Bold="false"></asp:Label>
                </td>
                 <td align="right" class="style1">
            ...
            <tr id="upload" runat="server">
                ...
                <td align="center">
                    <asp:Button ID="btnUpload" runat="server" CssClass="SmallButton2" Text="Upload" OnClick="btnUpload_Click"
                        Width="60px" Enabled="true"></asp:Button>
                </td>
                <td>
                    <asp:Button ID="BtnDoc" runat="server" CssClass="SmallButton2" Text="From Docs" 
                        Width="60px" onclick="BtnDoc_Click" Enabled="false" Visible="false"></asp:Button>        
                </td>
            </tr>
            ...
            <tr id="notes" runat="server">
                ...
                <td align="left" colspan="6">
                    <asp:TextBox ID="txtNotes" runat="server" CssClass="SmallTextBox" Width="520px" MaxLength="500"
                        TextMode="MultiLine" Height="60px" Enabled="true"></asp:TextBox>
                </td>
                <td align="left">
                 ...
                 <td align="right" class="style1">
                    ...
                    <td  class="style1" colspan="3">
                     ...
                     <td align="center" class="style1">
                        ...
                        Width="70px" onclick="btndelay_Click" Visible="False" Enabled="false"  />
                    </td>
             </tr>
            <tr align="center">
                <td class="style1">
                <asp:HyperLink runat="Server" ID="TempDown" >Project Proposal & Approval Form 立项模版</asp:HyperLink>
                    <br />
                    <br />
                ...
                <td align="center" class="style1">
                    ...
                    OnClick="btnSave_Click" Enabled="true"  />
                </td>
                <td style="width: 84px" align="center">
                    <asp:Button ID="btnEvaluate" runat="server" CssClass="SmallButton2" Text="Approve"
                        Width="50px" OnClick="btnEvaluate_Click" Enabled="false" Visible="False"  />
                </td>
                <td style="width: 84px" align="center">
                    <asp:Button ID="btnCancelEvaluate" runat="server" CssClass="SmallButton2" Text="DisApprove"
                        Width="70px" OnClick="btnCancelEvaluate_Click" 
                        ToolTip="当步骤所有的审批都审批完成以后才可以进行取消审批的操作" Enabled="false" Visible="False" />
                </td>
                <td style="width: 84px" align="center">
                    <asp:Button ID="btnFinish" runat="server" CssClass="SmallButton2" Text="Member Finish"
                        Width="85px" OnClick="btnFinish_Click" Enabled="false" Visible="False" />
                    <asp:Button ID="btnCancelFinish" runat="server" CssClass="SmallButton2" Text="Cancel Finish"
                        Width="85px" OnClick="btnCancelFinish_Click" Enabled="false" Visible="False" />
                </td>
                
                <td style="width: 84px" align="center">
                    <asp:Button ID="btnBack" runat="server" CssClass="SmallButton2" Text="Back" Width="50px"
                        OnClick="btnBack_Click" />
                       <asp:Button ID="btn_Doc" runat="server" CssClass="SmallButton2" Text="Doc" Width="50px" OnClick="btn_Doc_Click" Enabled="false" Visible="False"
                        />
                </td>
                 <td align="center" class="style1">
                ...
                <td>
                   <asp:Button ID="btnSample" runat="server" CssClass="SmallButton2" 
                        Text="Link Sample" Width="80px" onclick="btnSample_Click" Enabled="false" Visible="False" />
                   <asp:Button ID="btnTrack" runat="server" CssClass="SmallButton2" 
                        Text="Track" Width="80px" OnClick="btnTrack_Click" Enabled="false" Visible="False" />
                </td>
            </tr>
            <tr>
