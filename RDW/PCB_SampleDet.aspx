<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PCB_SampleDet.aspx.cs" Inherits="RDW_PCB_SampleDet" %>
            ...
            <tr>
                <td colspan="2" class="style2">
                    <asp:GridView ID="gv_det" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        CssClass="GridViewStyle" OnPageIndexChanging="gv_det_PageIndexChanging" DataKeyNames="bos_nbr,bos_det_line,bos_det_qad"
