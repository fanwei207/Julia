        ...
        <table cellspacing="0" cellpadding="0" style="width: 872px" class="main_top">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <asp:TextBox ID="txtRemarks" runat="server"  Width="700px" CssClass="smalltextbox" TextMode="MultiLine" Height="60px"></asp:TextBox>
                </td>
                <td class="main_right">
                </td>
            </tr>
        ...
        <asp:GridView ID="gvProject" runat="server" AutoGenerateColumns="False" DataKeyNames="proID,isGB,tID"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Re">
                 ...
                 <asp:TemplateField HeaderText="检测频次(H)">
                    <ItemTemplate>
                        <%#Eval("proCheckPerTime")%></ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtChkPer" runat="server" Text='<%# Bind("proCheckPerTime") %>' Width="100%" CssClass="smalltextbox Numberic"></asp:TextBox>
                    </EditItemTemplate>
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtSort" runat="server" Text='<%# Bind("proSort") %>' CssClass="smalltextbox"
                            Width="100%"></asp:TextBox>
                    </EditItemTemplate>
                    <ItemStyle HorizontalAlign="center" />
                    <HeaderStyle Width="50px" />
                    <ItemTemplate>
                        <asp:Label ID="lbSort" runat="server" Text='<%# Bind("proSort") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
