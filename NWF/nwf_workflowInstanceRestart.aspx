<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nwf_workflowInstanceRestart.aspx.cs" Inherits="NWF_nfw_workflowInstanceRestart" %>
        ...
        <asp:HiddenField ID="hidCheck" runat="server"  Value=";"/>
         ...
         <tr>
            ...
            节点名称
             ...
             <td class="style6">
                 <asp:DropDownList ID="ddlStatus" runat="server" style="margin-left: 0px" Visible="False">
             ...
             <tr>
                 ...
                 <td>
                     <asp:Button ID="btnRestart" runat="server" Text="重启审批" CssClass="SmallButton2" OnClick="btnRestart_Click" />
                 </td>
             </tr>      
             <tr>
                 <td align="right" class="style4">
                 ...
                 <td>
                     ...
                     style=" width:300px; height: 24px;" type="file" />
                 ...
                 <td>
                     <asp:Button ID="btnupdate" runat="server" Text="上传重启" CssClass="SmallButton2" OnClick="btnupdate_Click"  /></td>
             </tr>      
         <tr>
         <td colspan="5">
