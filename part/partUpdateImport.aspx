<%@ Page Language="C#" AutoEventWireup="true" CodeFile="partUpdateImport.aspx.cs" Inherits="part_partUpdateImport" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddldomain" runat="server">
                                <asp:ListItem Selected="True">SZX</asp:ListItem>
                                <asp:ListItem>ZQL</asp:ListItem>
                                <asp:ListItem>HQL</asp:ListItem>
                                <asp:ListItem>TCB</asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td style="height: 20px; text-align: left;">
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Size="11px"
                                Font-Underline="True" NavigateUrl="~/docs/updateImportpart.xls" Width="62px" 
