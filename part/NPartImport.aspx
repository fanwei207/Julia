<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NPartImport.aspx.cs" Inherits="part_NPartImport" %>
...
&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="height: 20px; text-align: left;">
                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:linkbutton ID="HyperLink1" runat="server" Font-Bold="False" Font-Size="11px"
                                Font-Underline="True"  Width="62px" 
                                Target="_blank" OnClick="HyperLink1_Click">Template</asp:linkbutton>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 5; width: 219px;">
