<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bg_ApplyActual.aspx.cs" Inherits="bg_ApplyActual" %>
    ...
    <div align="center">
        ...
        <table cellspacing="2" cellpadding="2" width="750px" bgcolor="white" border="0">
            ...
            <tr>
                ...
                <td align="center">
                    <asp:Button ID="btnReceipt" runat="server" CssClass="SmallButton2" Width="40px" TabIndex="5"
            ...
            <tr>
                ...
                <td align="center">
                    <asp:Button ID="btnCopyTo" runat="server" CssClass="SmallButton2" Width="40px" TabIndex="6"
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblActual" runat="server" Width="100px" CssClass="LabelRight" Text="实际金额:"
                        Font-Bold="false"></asp:Label>
                </td>
                <td align="left" colspan="6">
                    <asp:TextBox ID="txtActual" runat="server" CssClass="SmallTextBox" Width="650px"
            ...
            <tr>
                ...
                <td align="center" style="width: 200px">
                    <asp:Button ID="btnOK" runat="server" CssClass="SmallButton2" TabIndex="7" Text="确定"
