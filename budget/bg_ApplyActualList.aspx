<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bg_ApplyActualList.aspx.cs"
    Inherits="bg_ApplyActualList" %>
...
<body>
    ...
    <div align="center">
        <table id="tblHead" runat="server" cellspacing="0" cellpadding="0" width="780px"
            ...
            <tr height="20px">
                ...
                <td align="center">
                    <asp:TextBox ID="txtApplicant" runat="server" Width="100px" TabIndex="1"></asp:TextBox>
                </td>
                <td align="right">
                ...
                <td align="center">
                    <asp:TextBox ID="txtDept" runat="server" Width="120px" TabIndex="2"></asp:TextBox>
                </td>
                <td align="right">
                ...
                <td align="center">
                    <asp:TextBox ID="txtKeyword" runat="server" Width="120px" TabIndex="3"></asp:TextBox>
                </td>
                <td>
        ...
        <asp:GridView ID="gvApply" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            DataKeyNames="ApplyID" OnPageIndexChanging="gvApply_PageIndexChanging" Width="780px"
