...
public partial class price_pcm_MadeInquiryList : System.Web.UI.Page
{
    ...
    protected void gvVenderList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "lkbtnQuotation")
        {
            ...
            Response.Redirect("pcm_MadeInquiry.aspx?vender=" + vender + "&From=0&venderName=" + venderName);
        ...
        if (e.CommandName == "lkbtnInquiry")
        {
            string vender = e.CommandArgument.ToString();
            int index = ((GridViewRow)(((LinkButton)e.CommandSource).Parent.Parent)).RowIndex;
            Response.Redirect("pcm_InquiryList.aspx?vender=" + vender);
        }
