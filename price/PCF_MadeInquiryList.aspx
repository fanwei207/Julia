<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PCF_MadeInquiryList.aspx.cs" Inherits="price_PCF_MadeInquiryList" %>
...
<body>
    ...
    <div align="center">
        <table>
            ...
            <tr>
                <td colspan="4">
                    <asp:GridView ID="gvVenderList" runat="server" AutoGenerateColumns="false" CssClass="GridViewStyle GridViewRebuild"
                        AllowPaging="true" PageSize="20" OnRowCommand="gvVenderList_RowCommand" 
                        OnPageIndexChanging="gvVenderList_PageIndexChanging" DataKeyNames="PCF_vender,PCF_venderName">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="供应商名称" DataField="PCF_venderName">
                            ...
                            <asp:TemplateField HeaderText="未成单数量">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:LinkButton ID="lkbtnQuotation" runat="server" CommandName="lkbtnQuotation" CommandArgument='<%# Eval("PCF_vender") %>'
                            ...
                            <asp:TemplateField HeaderText="未完成询价单">
                                ...
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <asp:LinkButton ID="lkbtnInquiry" runat="server" CommandName="lkbtnInquiry" CommandArgument='<%# Eval("PCF_vender") %>'
