<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pc_FinCheckApply.aspx.cs" Inherits="price_pc_FinCheckApply" %>
    ...
    <table cellpadding="0" cellspacing="0" style="text-align: left">
        ...
        <table style="text-align: center; width: 1800px;">
                ...
                <td>
                        ...
                        CssClass="GridViewStyle"  DataKeyNames="isout,DetId,PQDetId,Price,PriceSelf,PriceDiscount,CheckPrice,IMID" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="技术部指定" DataField="InfoFrom" ReadOnly="True">
                            ...
                            <asp:TemplateField HeaderText="批准核价">
                                <ItemTemplate>
                                    <asp:Textbox ID="txtCheckPrice"  OnTextChanged="txtCheckPrice_TextChanged" runat="server" AutoPostBack ="true"  Text='<%# Eval("FinCheckPrice")%>' CssClass="Numeric" Width="60px"></asp:Textbox>
                                </ItemTemplate>
