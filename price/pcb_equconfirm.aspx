<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pcb_equconfirm.aspx.cs" Inherits="pcb_equconfirm" %>
...
<body>
    <div align="center">
        ...
        <asp:Label ID="lbEqu" runat="server" Text="1" Visible="False"></asp:Label>
        </form>
    </div>
    <script>
