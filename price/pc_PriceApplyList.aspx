<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pc_PriceApplyList.aspx.cs"
    Inherits="price_pc_PriceApplyList" %>
        ...
        <table style="width: 850px">
            <tr style="height: 25px;">
                ...
                &nbsp;&nbsp;
                    ...
                    <asp:Button ID="btnAddApply" runat="server" Text="申请新报价" CssClass="SmallButton2" OnClick="btnAddApply_Click" />

                </td>
                            <td rowspan ="2" align="right" style=" width:100px">
                                  <asp:Button ID="btnAddApplyOut" runat="server" Text="申请委外新报价" CssClass="SmallButton2" OnClick="btnAddApplyOut_Click"  />
