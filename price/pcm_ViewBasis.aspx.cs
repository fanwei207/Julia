...
public partial class price_pcm_ViewBasis : BasePage
{
    ...
    private void bind()
    {
       ...
       DataTable dt = pc.viewBasis(lbIMID.Text,out flag);

       if (flag == "0")
       {
           btnUpload.Enabled = false;
           gvBasisInfo.Columns[3].Visible = false;
       }
    ...
    {
        Response.Redirect("pcm_PriceApply.aspx?PQID=" + Request["IMID"].ToString() + "&Status=" + Request["Status"].ToString().Trim() + "&isout=" + Request["isout"].ToString());
    }
    /// <summary>
    /// 上传文件
    /// </summary>
