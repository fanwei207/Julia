...
public partial class price_pcm_ApplyPersonList : System.Web.UI.Page
{
    ...
    {
        ltlAlert.Text = "var w=window.open('pcm_chooseApplyPreson.aspx','docitem','menubar=No,scrollbars = No,resizable=No,width=500,height=500,top=200,left=300'); w.focus();";
        bind();
    }
