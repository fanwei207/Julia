<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pc_PartCheckPriceList.aspx.cs" Inherits="price_pc_PartCheckPriceList" %>
...
<%--                    <asp:CheckBox ID="chkStatus" runat="server" Text="核价完成"
...
<%--                    <asp:Button ID="BtnExport" runat="server" CssClass="SmallButton2" 
        ...
        <asp:GridView ID="gv" AllowPaging="false" AutoGenerateColumns="False" PageSize="25"
            CssClass="GridViewStyle" runat="server" Width="1500px" DataKeyNames="DetId,IMID,isout"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="报价" DataField="Price" ReadOnly="True">
                    <HeaderStyle HorizontalAlign="Center" Width="80px" />
                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:BoundField>
