...
public partial class price_pc_FinCheckDayList : System.Web.UI.Page
{
    PC_FinCheckApply helper = new PC_FinCheckApply();
    ...
    protected void gvInfo_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "lkbtnList")
        {
            ...
            Response.Redirect("pc_FinCheckDayDet.aspx?vender=" + vender + "&venderName=" + venderName + "&date=" + date);
        }
    }
