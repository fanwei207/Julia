...
public partial class price_pc_PartCheckPriceList : BasePage
{
    ...
    private void BindData()
    {
        ...
        gv.DataSource = helper.GetPartCheckPriceFinishedList(part, code, vender,venderName);
        gv.DataBind();
    }
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        //    ltlAlert.Text = "var w=window.open('pc_FinCheckApplyPart.aspx?part=" + part + "&PQID="+PQID+"')"; 
        //}
    }
