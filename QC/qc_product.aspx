<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qc_product.aspx.cs" Inherits="QC_qc_product" %>
            ...
            <tr>
                <td style="vertical-align: top;">
                    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" CellPadding="1"
                        ...
                        DataKeyNames="prdID,prdOrder,prdLine,prdqad,wo_qty_ord,prdGuest,prdCDate,prdCBy" OnRowCancelingEdit="gvProduct_RowCancelingEdit"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="prdLine,prdOrder,prdNum,wo_part,prdID"
                                DataNavigateUrlFormatString="qc_product_input.aspx?line={0}&amp;ord={1}&amp;rec={2}&amp;part={3}&amp;ID={4}"
