...
public partial class QC_qc_product_second : BasePage
{
    ...
    private void GridViewBind()
    {
        ...
        if (bFlag)
        {
            DataSet _dataset = oqc.GetProductSecond(txtOrder.Text.Trim(),
                                                txtID.Text.Trim(),
                                                txtBoard.Text.Trim(),
                                                txtDate.Text.Trim(),
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (bFlag)
        {
            ...
            errtype = oqc.AddProductSecond(strFloor, strBoard, strDate, strInspector,
    ...
    protected void txtID_TextChanged(object sender, EventArgs e)
    {
        ...
        if (bFlag)
        {
            ...
            error = oqc.GetProductSnatchSecond(txtID.Text.Trim().Replace(" ", ""), txtOrder.Text.Trim().Replace(" ", ""), ref table);
    ...
    protected void gvProduct_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        errtype = oqc.DeleteProductSecond(int.Parse(strID), uID, ref strMsg);
    ...
    protected void gvProduct_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        if (bFlag)
        {
            ...
            errtype = oqc.ModifyProductSecond(prdID, tBoard.Text.Trim(), tDate.Text.Trim(), tInspector.Text.Trim(), tExaminer.Text.Trim(),
