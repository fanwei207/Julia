<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qc_product_tcp.aspx.cs" Inherits="QC_qc_product" %>
...
<body>
    <div align="left">
        ...
        <table runat="server" id="tbHeader" width="1000" class="MainContent_inner" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left">
                    加工单号:
                </td>
                ...
                <td align="left" colspan="4">
                    <table style="width: 89%; height: 100%;">
                        <tr>
                            ...
                            <td style="border: 1px solid Black; background-color: silver" class="style4">
            ...
            <tr>
                ...
                <td align="left" colspan="7">
                    ...
                    <asp:CheckBox ID="chkfree" runat="server" Text="隐藏免检" />
                    <asp:Label ID="lbOut" runat="server" Text="Label" Visible="False"></asp:Label>
                </td>
                <td colspan="2">
            ...
            <tr>
                <td style="vertical-align: top;">
                    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" CellPadding="1"
                        ...
                        DataKeyNames="prdID,prdOrder,prdLine,prdqad,wo_qty_ord,prdIsExemption,prdCDate,prdCBy" OnRowCancelingEdit="gvProduct_RowCancelingEdit"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="是否免检">
                                <HeaderStyle Width="65px" />
                                <ItemTemplate >
                            ...
                            <asp:HyperLinkField  DataNavigateUrlFields="prdLine,prdOrder,prdNum,wo_part,prdID"
                                DataNavigateUrlFormatString="qc_product_input_tcp.aspx?line={0}&amp;ord={1}&amp;rec={2}&amp;part={3}&amp;ID={4}"
                            ...
                            <asp:TemplateField HeaderText="光色检验">
                              ...
                              <asp:TemplateField HeaderText="返工检验">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lkbtnRework" runat="server" CommandName="lkbtnRework">查看</asp:LinkButton>&nbsp;
