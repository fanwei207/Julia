...
<body>
    <div align="center">
        ...
        <table cellspacing="0" cellpadding="0" style="width: 400px" class="main_top">
            <tr>
                <td class="main_left">
                </td>
                <td>
                    类别:<asp:TextBox ID="txtType" runat="server" Width="100px" CssClass="SmallTextBox"></asp:TextBox>
