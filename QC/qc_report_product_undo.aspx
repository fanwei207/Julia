<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qc_report_product_undo.aspx.cs" Inherits="QC_qc_report_product_undo" %>
                    ...
                    收货单号:<asp:TextBox ID="txtReceiver" runat="server" CssClass="SmallTextBox" Width="90px"
                        TabIndex="1"></asp:TextBox>&nbsp; 采购单:<asp:TextBox ID="txtOrder" runat="server" CssClass="SmallTextBox"
                            TabIndex="2" Width="90px"></asp:TextBox>行号:<asp:TextBox ID="txtLine" runat="server"
                                CssClass="SmallTextBox" TabIndex="2" Width="90px"></asp:TextBox>物料号:<asp:TextBox
                                    ID="txtPart" runat="server" CssClass="SmallTextBox Part" Width="90px" TabIndex="3"></asp:TextBox>供应商:<asp:TextBox
                                        ID="txtCus" runat="server" CssClass="SmallTextBox Supplier" TabIndex="3" Width="90px"></asp:TextBox><br />
                    收货日期:<asp:TextBox ID="txtStd" runat="server" CssClass="smalltextbox Date" Width="100px"
