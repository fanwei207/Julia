<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qc_report_product_complete.aspx.cs" Inherits="QC_qc_report_product_complete" %>
    ...
    <div align="center">
        ...
        <table runat="server" id="tbHeader" cellspacing="2" cellpadding="2" bgcolor="white" border="0" width="800px">
            ...
            <tr>
                ...
                <td>
                    <asp:Button  runat="server" ID="btnExport" Text="导出" CssClass="SmallButton2" Width="50px" OnClick="btnExport_Click"/>
                </td>
                <td>
