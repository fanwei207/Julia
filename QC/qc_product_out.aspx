<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qc_product_out.aspx.cs" Inherits="QC_qc_product" %>
                    ...
                    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" CellPadding="1"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="prdLine,prdOrder,prdNum,wo_part,prdID"
                                DataNavigateUrlFormatString="qc_product_input_out.aspx?line={0}&amp;ord={1}&amp;rec={2}&amp;part={3}&amp;ID={4}"
                            ...
                            <asp:CommandField DeleteText="<u>删除</u>" ShowDeleteButton="True">
                             ...
                             <asp:TemplateField HeaderText="质检报告">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnSelectBasis" runat="server" CommandName="lbtnSelectBasis" CommandArgument ="<%#  ((GridViewRow) Container).RowIndex %>">查看</asp:LinkButton>
                                </ItemTemplate>
                                <ControlStyle Font-Bold="False" Font-Size="12px" Font-Underline="True" />
                                <HeaderStyle Width="70px" />
                                <ItemStyle HorizontalAlign="Center" />
