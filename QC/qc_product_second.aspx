<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qc_product_second.aspx.cs" Inherits="QC_qc_product_second" %>
                    ...
                    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" CellPadding="1"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="prdLine,prdOrder,prdNum,wo_part,prdID"
                                DataNavigateUrlFormatString="qc_product_input_second.aspx?line={0}&amp;ord={1}&amp;rec={2}&amp;part={3}&amp;ID={4}"
