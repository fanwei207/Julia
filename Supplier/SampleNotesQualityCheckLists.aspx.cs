...
public partial class supplier_SampleNotesLists : BasePage
{
    ...
    private void Bindgv_Bos()
    {
        ...
        string checkValue = ddl_QualValue.SelectedValue;
        DataTable dt = sap.getBosMstrToCheck(strBosnbr, strVend, createdDate1, createdDate2, checkValue, "Qual");
        if (dt.Rows.Count == 0)
        {
    ...
    protected void gv_bos_mstr_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        { 
            ...
            Response.Redirect("SampleNotesQualityCheckMaintain.aspx?bos_nbr=" + bosNbr);
        } 
    }
}
