<%@ Page Language="C#" AutoEventWireup="true"  
    CodeFile="SampleNotesQualityCheckMaintain.aspx.cs" Inherits="supplier_SampleReceiveNotesMaintain" %>
            ...
            <tr>
                <td colspan="5" align="center">
                    <asp:CheckBox ID="chk_isVendConfirm" runat="server" Enabled="false" Text="供应商确认"
                        Visible="False" />
                    &nbsp;&nbsp; &nbsp;&nbsp;
                    <asp:Button ID="btn_Back" runat="server" Text="返回" Width="65px" OnClick="btn_Back_Click"
                        CssClass="SmallButton2" />
                </td>
            </tr>
        </table>
        <br />
        <table id="tb_bosdet" runat="server" style="text-align: center; width: 1000px;">
            <tr>
                <td colspan="2">
                    <asp:Panel ID="Panel1" runat="server" Width="1000px" ScrollBars="Horizontal">
                        <asp:GridView ID="gv_det" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            CssClass="GridViewStyle" OnPageIndexChanging="gv_det_PageIndexChanging" DataKeyNames="bos_nbr,bos_det_line,bos_det_isReceipt,isApproved"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="验收结果">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQuality" runat="server" Text='<%# Eval("bos_det_qualityConfirm")%>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddl_QualConfirm" runat="server">
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="linkApprove" runat="server" CommandName="Auth" Font-Size="12px"
                                            ForeColor="Black" Text="<u>正常</u>" Font-Underline="false"></asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="40px" />
                                    <ItemStyle HorizontalAlign="Center" Width="40px" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="bos_det_qualityConfirmDate" HeaderText="验收日期" ReadOnly="true"
                                    DataFormatString="{0:yyyy-MM-dd}">
                                    <HeaderStyle HorizontalAlign="Center" Width="90px" />
                                    <ItemStyle HorizontalAlign="Center" Width="90px" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="原因">
                                    <ItemTemplate>
                                        <asp:Label ID="lblReason" runat="server" Text='<%# Eval("bos_det_qualityReason")%>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
