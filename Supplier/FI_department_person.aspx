<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.NWF_FlowNodePerson" CodeFile="FI_department_person.aspx.vb" %>
...
<body>
    <form id="Form1" runat="server">
        <table id="table1" cellpadding="0" cellspacing="0" width="400" align="center">
            ...
            <tr>
                <td valign="top" align="left" width="450" colspan="2" style="height: 20px">公司<asp:DropDownList ID="ddl_Company" runat="server" Width="200px" AutoPostBack="True">
                </asp:DropDownList>
                    <asp:CheckBox ID="ckbreal" runat="server" Checked="True" Text="是否去实地" />
                </td>
            </tr>
            <tr>
                <td valign="top" align="left" width="450" colspan="2">部门<asp:DropDownList ID="ddl_department" runat="server" Width="180px" AutoPostBack="True">
                </asp:DropDownList>
