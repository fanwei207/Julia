<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SampleNotesTechCheckLists.aspx.cs"
        ...
        <table width="1000px">
            <tr>
                <td>
                    ...
                    <asp:DropDownList ID="ddl_TechValue" runat="server" Width="84px">
                        <asp:ListItem Value="0" Selected="True">待检验</asp:ListItem>
                        <asp:ListItem Value="1">已检验</asp:ListItem>
                ...
                <td colspan="2">
                    <asp:GridView ID="gv_bos_mstr" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="技术检验">
                                <ItemTemplate>
                                    <asp:LinkButton ID="linkDetail" runat="server" CommandName="Detail" Font-Underline="True"
                                        CommandArgument='<%# Eval("bos_nbr") %>' ForeColor="Black">操作</asp:LinkButton>
                                </ItemTemplate>
