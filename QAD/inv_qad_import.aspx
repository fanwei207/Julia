<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.inv_qad_import" CodeFile="inv_qad_import.aspx.vb" %>
            ...
            <tr>
                <td align="center">
                    <table style="width: 680px; height: 100px" cellpadding="0" bgcolor="#ccffff">
                        <tr>
                            <td colspan="2">
                                <font face="Verdana, Arial, Helvetica, sans-serif" color="#cc0000"><b>导入QAD库存数的格式如下：</b><br>
                                    <table height="60" cellspacing="0" cellpadding="2" width="100%" border="0">
                                        <tr>
                                            ...
                                            <td width="10%">
                                                <font face="Verdana, Arial, Helvetica, sans-serif"><b>批序号</b></font>
                                            </td>
                                            <td width="10%">
                                                <font face="Verdana, Arial, Helvetica, sans-serif"><b>库存数</b></font>
                                            </td>
                                            <td width="10%">
                                                <font face="Verdana, Arial, Helvetica, sans-serif"><b>库存状态</b></font>
                                            </td>
                                            <td width="10%">
                                                <font face="Verdana, Arial, Helvetica, sans-serif"><b>单位</b></font>
                                            </td>
                                            <td width="10%">
                                                <font face="Verdana, Arial, Helvetica, sans-serif"><b>成本</b></font>
                                            </td>
                                            <td width="10%">
                                                <font face="Verdana, Arial, Helvetica, sans-serif"><b>金额</b></font>
                                            </td>
                                            <td width="10%">
            ...
            <tr>
                ...
                <td align="left" width="135">
                    <label id="here" onclick="submit();">
                        <a href="/docs/inv_Qad_import.xls" target="blank"><font color="blue">导入QAD库存数的模版</font></a></label>
                </td>
                <td align="center">
