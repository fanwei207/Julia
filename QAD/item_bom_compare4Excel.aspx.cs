...
public partial class QAD_item_bom_compare4Excel : System.Web.UI.Page
{
    ...
    public void ToExcel()
    {
        ...
        cells1.Add(1, 5, "修改类型", XFstyle1);
        cells1.Add(1, 6, "100库子件", XFstyle1);
        cells1.Add(1, 7, "100库单位用量", XFstyle1);
        cells1.Add(1, 8, "100库层级", XFstyle1);
        ...
        dt1 = ibc.CompareItemStru2(Convert.ToInt32(uID), strLevel); 
        int i = 1;
        for (int n = 0; n < dt1.Rows.Count; n++)
        {
            ...
            cells1.Add(i, 5, dt1.Rows[n].IsNull("item_bom_crud") == true ? "" : dt1.Rows[n]["item_bom_crud"], XFstyle1);
            cells1.Add(i, 6, dt1.Rows[n].IsNull("product_bom_comp") == true ? "" : dt1.Rows[n]["product_bom_comp"], XFstyle1);
            cells1.Add(i, 7, dt1.Rows[n].IsNull("product_bom_qty") == true ? "" : dt1.Rows[n]["product_bom_qty"], XFstyle1);
            cells1.Add(i, 8, dt1.Rows[n].IsNull("product_bom_lel") == true ? "" : dt1.Rows[n]["product_bom_lel"], XFstyle1);
