<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.inv_count" CodeFile="inv_count.aspx.vb" %>
...
<body>
    <div align="center">
        ...
        <table id="table1" cellspacing="0" cellpadding="0" width="900">
            ...
            <tr>
                <td>
                    地点<asp:TextBox ID="txtSite" TabIndex="0" runat="server" CssClass="SmallTextBox" MaxLength="4"
                        Width="100px"></asp:TextBox>&nbsp; 库位<asp:TextBox ID="txtLoca" TabIndex="0" runat="server"
                            CssClass="SmallTextBox" MaxLength="18" Width="100px"></asp:TextBox>&nbsp;
                    零件号<asp:TextBox ID="txtItem" TabIndex="0" runat="server" CssClass="SmallTextBox"
                ...
                <td>
                    ...
                    <asp:Button ID="Button1" TabIndex="0" runat="server" CssClass="SmallButton3" Width="50"
                        Text="删除"></asp:Button>&nbsp;
                    <asp:Button ID="Button2" TabIndex="0" runat="server" CssClass="SmallButton3" Width="50"
                        Text="导入"></asp:Button>&nbsp;
                    <asp:Button ID="Button3" TabIndex="0" runat="server" CssClass="SmallButton3" Width="50"
                        Text="返回"></asp:Button>&nbsp;
                </td>
            </tr>
        </table>
        <asp:DataGrid ID="Datagrid1" runat="server" Width="900px" CssClass="GridViewStyle AutoPageSize"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="tag" SortExpression="tag" HeaderText="标签号">
                ...
                <asp:BoundColumn DataField="qty" SortExpression="qty" HeaderText="盘点量" DataFormatString="{0:##,##0.###}">
