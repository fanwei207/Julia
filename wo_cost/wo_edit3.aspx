<%@ Page Language="vb" AutoEventWireup="false" Inherits="tcpc.wo_edit3" CodeFile="wo_edit3.aspx.vb" %>
            ...
            <table id="table1" cellspacing="0" cellpadding="0" width="980">
                <tr>
                    <td colspan="2">
                        ...
                        <asp:Label ID="lbl_cost" runat="server" Width="80"></asp:Label>&nbsp; 裸灯只数:
                ...
                <tr>
                    <td colspan="2">
                        ...
                        &nbsp;&nbsp;&nbsp;日期<asp:TextBox ID="txtDate" runat="server" Width="70px"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnDelete" runat="server" Text="删除" Width="100px" CssClass="SmallButton3" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <asp:DataGrid ID="Datagrid1" runat="server" Width="1960px" AllowSorting="false" CssClass="GridViewStyle AutoPageSize"
            OnUpdateCommand="Edit_update" OnCancelCommand="Edit_cancel">
