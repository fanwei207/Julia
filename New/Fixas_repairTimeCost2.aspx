<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fixas_repairTimeCost2.aspx.cs"
    Inherits="new_Fixas_repairTimeCost2" %>
...
<body style="text-align: center;">
    ...
    <div style="text-align: center;">
        <table style="margin: 0 auto; padding: 5px; width: 1036px;" border="0" cellpadding="0"
            cellspacing="0">
            <tr>
                <td style="width: 17%;">
                ...
                <td style="width: 25%;">
                    <asp:Label ID="Label3" runat="server" Text="维修结束时间"></asp:Label>
                    <asp:TextBox ID="txbRepairDate1" runat="server" CssClass="SmallTextBox Date" Width="80px"></asp:TextBox>
                    <asp:Label ID="Label4" runat="server" Text="-"></asp:Label>
                    <asp:TextBox ID="txbRepairDate2" runat="server" CssClass="SmallTextBox Date" Width="80px"></asp:TextBox>
                </td>
                <td style="width: 20%;">
            ...
            <EmptyDataTemplate>
                <asp:Table ID="Table1" Width="1480px" CellPadding="0" CellSpacing="0" runat="server"
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableCell Text="详细类型" Width="115px" HorizontalAlign="center"></asp:TableCell>
                        ...
                        <asp:TableCell Text="维修单" Width="115px" HorizontalAlign="center"></asp:TableCell>
                        <asp:TableCell Text="维修人" Width="115px" HorizontalAlign="center"></asp:TableCell>
                        <asp:TableCell Text="申请维修时间" Width="115px" HorizontalAlign="center"></asp:TableCell>
                        <asp:TableCell Text="维修开始时间" Width="115px" HorizontalAlign="center"></asp:TableCell>
                        <asp:TableCell Text="维修结束时间" Width="115px" HorizontalAlign="center"></asp:TableCell>
