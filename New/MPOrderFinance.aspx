<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MPOrderFinance.aspx.cs" Inherits="new_MPOrderFinance" %>
...
<body>
    <div align="center">
        ...
        <br />
        <asp:GridView ID="gvMPFin" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
            CssClass="GridViewStyle" runat="server" PageSize="20" DataKeyNames="Aid" Width="960px"
            OnRowCommand="gvMPFin_RowCommand" DataSourceID="obdsF">
            ...
            <Columns>
                ...
                <asp:ButtonField Text="核销" ItemStyle-ForeColor="black" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center"
                    CommandName="1" />
        ...
        <br />
        <asp:ObjectDataSource ID="obdsF" runat="server" SelectMethod="MPFinance" TypeName="MinorP.MinorPurchase">
            <SelectParameters>
                ...
                <asp:SessionParameter DefaultValue="" Name="intUid" SessionField="uid" Type="Int32" />
            </SelectParameters>
        ...
        <table id="table2" cellspacing="0" cellpadding="0" width="800" style="font-size: 10pt"
            ...
            <tr>
                <td colspan="2">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 接收数量：&nbsp;<asp:Label ID="lblRqty" runat="server"
                        Width="100px"></asp:Label>
                </td>
            </tr>
        </table>
        <br />
        <br />
        <table id="table3" cellspacing="0" cellpadding="0" width="800" runat="server" visible="false">
            <tr>
                <td>
                    &nbsp;&nbsp;&nbsp;&nbsp;发票号：<asp:TextBox ID="txtFinNum" runat="server" Width="180px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    发票单价：<asp:TextBox ID="txtFinprice" runat="server" Width="180px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    发票数量：<asp:TextBox ID="txtFinqty" runat="server" Width="180px"></asp:TextBox>
                </td>
            </tr>
            <tr style="height: 23px">
                <td>
            ...
            <tr>
                <td>
                    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button
                        ID="btnSave" runat="server" Text="核销" CssClass="SmallButton2" OnClick="btnSave_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnBack" runat="server"
                        Text="返回" CssClass="SmallButton2" OnClick="btnBack_Click" />
                </td>
            </tr>
        </table>
        </form>
