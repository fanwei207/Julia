<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FixAssetMaintenance.aspx.cs"
    Inherits="new_FixAssetMaintenance" %>
...
<head id="Head1" runat="server">
    ...
    <link media="all" href="../css/jquery-thickbox.css" rel="stylesheet" />

    <script language="JavaScript" src="../script/jquery-latest.js" type="text/javascript"></script>
    <script language="JavaScript" src="../script/julia.object.js" type="text/javascript"></script>
    <script language="JavaScript" src="../script/julia.validate.js" type="text/javascript"></script>
    <script language="JavaScript" src="../script/julia.common.js" type="text/javascript"></script>
    <script language="JavaScript" src="../script/jquery-thickbox.js" type="text/javascript"></script>
    ...
    <div align="center">
        <table id="tbFixAsset" runat="server" cellpadding="0" cellspacing="0">
            ...
            <tr id="trAsset7" runat="server">
                ...
                <td align="right" style="width: 116px; height: 24px">
                    <asp:Label ID="Label2" runat="server" Text=" 保养周期："></asp:Label>
                </td>
                <td style="width: 234px; height: 24px">
                    <asp:TextBox ID="txtMaintainPeriod" runat="server" TabIndex="10"></asp:TextBox>(按天计算)
                </td>
            </tr>
