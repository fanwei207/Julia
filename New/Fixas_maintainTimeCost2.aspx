<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fixas_maintainTimeCost2.aspx.cs"
    Inherits="new_Fixas_maintainTimeCost2" %>
    ...
    <div style="text-align: center;">
        <table style="margin: 0 auto; padding: 5px; width: 1000px;" border="0" cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 25%;">
                    <asp:Label ID="Label3" runat="server" Text="保养结束时间"></asp:Label>
