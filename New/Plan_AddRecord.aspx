<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Plan_AddRecord.aspx.cs" Inherits="Plan_AddRecord" %>
    ...
    <div align="center">
        ...
        <table cellspacing="2" cellpadding="2" bgcolor="white" border="0" style="width: 574px">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMaintDate" runat="server" CssClass="SmallTextBox4 date" TabIndex="1"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMoney" runat="server" CssClass="SmallTextBox4" TabIndex="1" Width="150px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
