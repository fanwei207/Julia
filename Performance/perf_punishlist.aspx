<%@ Page Language="VB" AutoEventWireup="false" CodeFile="perf_punishlist.aspx.vb" Inherits="tcpc.Performance_perf_punishlist" %>
    ...
    <div align="center">
        ...
        <asp:DataGrid ID="Datagrid1" runat="server" Width="880px" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:ButtonColumn Text="&lt;u&gt;评分/整改&lt;/u&gt;" CommandName="perf_act">
                    <HeaderStyle Width="60px"></HeaderStyle>
