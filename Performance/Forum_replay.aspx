<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Forum_replay.aspx.cs" Inherits="Supplier_Forum_replay" %>
...
<body>
    ...
    <div align="center">
        <table>
            ...
            <tr>
                <td align="left">
                    <asp:DropDownList  ID="ddlType" runat="server" DataTextField="fst_typeName" DataValueField="fst_typeId" Width="300px">
                    </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="cb_top" runat="server" Text ="TOP" Visible="false" />
                </td>
            </tr>
            <tr>
                <td style=" text-align:left;">
