<%@ Page Language="C#" AutoEventWireup="true" CodeFile="New_TypeNew.aspx.cs"
    Inherits="New_TypeNew" %>
...
<body>
    <div align="center">
        ...
        <table style="width: 730px" cellpadding="0" cellspacing="0">
            <tr valign="middle">
                <td align="left" style="width: 534px">
                    ...
                    类型:<asp:TextBox ID="txtDetail" runat="server" Width="154px" CssClass="SmallTextBox"
        ...
        <asp:GridView ID="gv" AllowSorting="True" AllowPaging="True" AutoGenerateColumns="False"
            PageSize="25" CssClass="GridViewStyle" runat="server" Width="730px" DataKeyNames="perft_id"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="类型" DataField="perft_type" ReadOnly="True">
                    <HeaderStyle HorizontalAlign="Center" Width="140px" />
                    <ItemStyle HorizontalAlign="Left" Width="140px" />
                </asp:BoundField>
                <asp:BoundField HeaderText="备注" DataField="perft_remark" ReadOnly="True">
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkEdit" Text="修改" ForeColor="black" Font-Underline="true"
                            Font-Size="12px" runat="server" CommandArgument='<%# Eval("perft_id") %>' CommandName="ModifyDesc" />
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="lnkDelete" Text="删除" ForeColor="black" Font-Underline="true"
                            Font-Size="12px" runat="server" CommandArgument='<%# Eval("perft_id") %>' CommandName="Delete" />
                    </ItemTemplate>
